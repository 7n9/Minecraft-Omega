								...
								if(block16 == null) {
									...
									if(i15 >= 0 && i15 < 160) {
										...
										if(i12 >= 0 && this.field_1186_c[i18] <= i14) {
											...
											this.field_1180_b[i18] = -16777216 | (int)(this.field_1181_a[i19 * 3 + 0] * f20) << 16 | (int)(this.field_1181_a[i19 * 3 + 1] * f20) << 8 | (int)(this.field_1181_a[i19 * 3 + 2] * f20);
										}
										...
										if(i12 < 31) {
											...
											if(this.field_1186_c[i18 + 1] <= i14) {
												...
												this.field_1180_b[i18 + 1] = -16777216 | (int)(this.field_1181_a[i19 * 3 + 0] * f22) << 16 | (int)(this.field_1181_a[i19 * 3 + 1] * f22) << 8 | (int)(this.field_1181_a[i19 * 3 + 2] * f22);
											}
										}
									}
									...
									if(i15 >= -1 && i15 < 159) {
										...
										if(i12 >= 0) {
											...
											if(this.field_1186_c[i18] <= i14 - 1) {
												...
												this.field_1180_b[i18] = -16777216 | (int)(this.field_1181_a[i19 * 3 + 0] * f23) << 16 | (int)(this.field_1181_a[i19 * 3 + 1] * f23) << 8 | (int)(this.field_1181_a[i19 * 3 + 2] * f23);
											}
										}
										...
										if(i12 < 31) {
											...
											if(this.field_1186_c[i18 + 1] <= i14 - 1) {
												...
												this.field_1180_b[i18 + 1] = -16777216 | (int)(this.field_1181_a[i21 * 3 + 0] * f23) << 16 | (int)(this.field_1181_a[i21 * 3 + 1] * f23) << 8 | (int)(this.field_1181_a[i21 * 3 + 2] * f23);
											}
										}
									}
								}
