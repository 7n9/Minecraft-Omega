...
public class ItemRenderer {
	...
	public void renderItemInFirstPerson(float f1) {
		...
		if(itemStack5 != null && itemStack5.itemID == Item.mapItem.shiftedIndex) {
			...
			f10 = MathHelper.sin(MathHelper.sqrt_float(f8) * 3.1415927F);
			GL11.glTranslatef(-f10 * 0.4F, MathHelper.sin(MathHelper.sqrt_float(f8) * 3.1415927F * 2.0F) * 0.2F, -f9 * 0.2F);
			...
			f8 = -MathHelper.cos(f8 * 3.1415927F) * 0.5F + 0.5F;
			...
			f10 = MathHelper.sin(f9 * f9 * 3.1415927F);
			float f18 = MathHelper.sin(MathHelper.sqrt_float(f9) * 3.1415927F);
			...
			GL11.glEnable(32826);
			f8 = entityPlayerSP3.getSwingProgress(f1);
			f9 = MathHelper.sin(f8 * f8 * 3.1415927F);
			f10 = MathHelper.sin(MathHelper.sqrt_float(f8) * 3.1415927F);
			...
			f9 = MathHelper.sin(f8 * 3.1415927F);
			f10 = MathHelper.sin(MathHelper.sqrt_float(f8) * 3.1415927F);
			GL11.glTranslatef(-f10 * 0.3F, MathHelper.sin(MathHelper.sqrt_float(f8) * 3.1415927F * 2.0F) * 0.4F, -f9 * 0.4F);
