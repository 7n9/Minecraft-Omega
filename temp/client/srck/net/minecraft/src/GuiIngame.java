...
public class GuiIngame extends Gui {
	...
	public void renderGameOverlay(float f1, boolean z2, int i3, int i4) {
		...
		if(this.mc.gameSettings.showDebugInfo) {
			...
			fontRenderer8.drawStringWithShadow("Minecraft Beta 1.7.3 (" + this.mc.debug + ")", 2, 2, 16777215);
			fontRenderer8.drawStringWithShadow(this.mc.func_6241_m(), 2, 12, 16777215);
			fontRenderer8.drawStringWithShadow(this.mc.func_6262_n(), 2, 22, 16777215);
			fontRenderer8.drawStringWithShadow(this.mc.func_6245_o(), 2, 32, 16777215);
			fontRenderer8.drawStringWithShadow(this.mc.func_21002_o(), 2, 42, 16777215);
		...
		if(this.recordPlayingUpFor > 0) {
			...
			if(i16 > 0) {
				...
				if(this.field_22065_l) {
					i17 = Color.HSBtoRGB(f25 / 50.0F, 0.7F, 0.6F) & 16777215;
				}
		...
		for(i17 = 0; i17 < this.chatMessageList.size() && i17 < b26; ++i17) {
			if(((ChatLine)this.chatMessageList.get(i17)).updateCounter < 200 || z31) {
				...
				if(i20 > 0) {
					...
					GL11.glEnable(3042);
					fontRenderer8.drawStringWithShadow(string23, b33, i22, 16777215 + (i20 << 24));
				}
			}
		}
