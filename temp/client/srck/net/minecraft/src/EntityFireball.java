...
public class EntityFireball extends Entity {
	...
	public void onUpdate() {
		...
		for(this.rotationPitch = (float)(Math.atan2(this.motionY, (double)f16) * 180.0D / 3.1415927410125732D); this.rotationPitch - this.prevRotationPitch < -180.0F; this.prevRotationPitch -= 360.0F) {
		}
