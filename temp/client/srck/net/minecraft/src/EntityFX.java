...
public class EntityFX extends Entity {
	...
	public EntityFX(World world1, double d2, double d4, double d6, double d8, double d10, double d12) {
		...
		this.motionX = this.motionX / (double)f15 * (double)f14 * 0.4000000059604645D;
		this.motionY = this.motionY / (double)f15 * (double)f14 * 0.4000000059604645D + 0.10000000149011612D;
		this.motionZ = this.motionZ / (double)f15 * (double)f14 * 0.4000000059604645D;
	...
	public EntityFX func_407_b(float f1) {
		...
		this.motionY = (this.motionY - 0.10000000149011612D) * (double)f1 + 0.10000000149011612D;
