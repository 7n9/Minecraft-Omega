...
public class EntityArrow extends Entity {
	...
	public void setVelocity(double d1, double d3, double d5) {
		...
		if(this.prevRotationPitch == 0.0F && this.prevRotationYaw == 0.0F) {
			...
			this.prevRotationYaw = this.rotationYaw = (float)(Math.atan2(d1, d5) * 180.0D / 3.1415927410125732D);
			this.prevRotationPitch = this.rotationPitch = (float)(Math.atan2(d3, (double)f7) * 180.0D / 3.1415927410125732D);
	...
	public void onUpdate() {
		...
		if(this.prevRotationPitch == 0.0F && this.prevRotationYaw == 0.0F) {
			...
			this.prevRotationPitch = this.rotationPitch = (float)(Math.atan2(this.motionY, (double)f1) * 180.0D / 3.1415927410125732D);
		}
		...
		if(this.inGround) {
			...
			if(movingObjectPosition3 != null) {
				if(movingObjectPosition3.entityHit != null) {
					...
					this.posX -= this.motionX / (double)f19 * 0.05000000074505806D;
					this.posY -= this.motionY / (double)f19 * 0.05000000074505806D;
					this.posZ -= this.motionZ / (double)f19 * 0.05000000074505806D;
					this.worldObj.playSoundAtEntity(this, "random.drr", 1.0F, 1.2F / (this.rand.nextFloat() * 0.2F + 0.9F));
					this.inGround = true;
					this.arrowShake = 7;
				}
			...
			for(this.rotationPitch = (float)(Math.atan2(this.motionY, (double)f19) * 180.0D / 3.1415927410125732D); this.rotationPitch - this.prevRotationPitch < -180.0F; this.prevRotationPitch -= 360.0F) {
			}
