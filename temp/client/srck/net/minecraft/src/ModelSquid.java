...
public class ModelSquid extends ModelBase {
	...
	public ModelSquid() {
		...
		for(int i2 = 0; i2 < this.squidTentacles.length; ++i2) {
			...
			double d3 = (double)i2 * 3.141592653589793D * 2.0D / (double)this.squidTentacles.length;
			...
			d3 = (double)i2 * 3.141592653589793D * -2.0D / (double)this.squidTentacles.length + 1.5707963267948966D;
