...
public class GuiConnecting extends GuiScreen {
	...
	public void drawScreen(int i1, int i2, float f3) {
		...
		if(this.clientHandler == null) {
			this.drawCenteredString(this.fontRenderer, stringTranslate4.translateKey("connect.connecting"), this.width / 2, this.height / 2 - 50, 16777215);
			this.drawCenteredString(this.fontRenderer, "", this.width / 2, this.height / 2 - 10, 16777215);
		} else {
			this.drawCenteredString(this.fontRenderer, stringTranslate4.translateKey("connect.authorizing"), this.width / 2, this.height / 2 - 50, 16777215);
