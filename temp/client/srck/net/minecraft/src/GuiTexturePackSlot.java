...
class GuiTexturePackSlot extends GuiSlot {
	...
	protected void drawSlot(int i1, int i2, int i3, int i4, Tessellator tessellator5) {
		...
		tessellator5.setColorOpaque_I(16777215);
		...
		tessellator5.draw();
		this.parentTexturePackGui.drawString(GuiTexturePacks.func_22127_j(this.parentTexturePackGui), texturePackBase6.texturePackFileName, i2 + 32 + 2, i3 + 1, 16777215);
