	...
	protected void updatePlayerActionState() {
		...
		if(this.pathToEntity != null && this.rand.nextInt(100) != 0) {
			...
			if(vec3D5 != null) {
				...
				float f14 = (float)(Math.atan2(d10, d8) * 180.0D / 3.1415927410125732D) - 90.0F;
				...
				if(this.hasAttacked && this.playerToAttack != null) {
					...
					this.rotationYaw = (float)(Math.atan2(d18, d16) * 180.0D / 3.1415927410125732D) - 90.0F;
					f15 = (f20 - this.rotationYaw + 90.0F) * 3.1415927F / 180.0F;
