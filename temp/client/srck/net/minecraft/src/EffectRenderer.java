...
public class EffectRenderer {
	...
	public void renderParticles(Entity entity1, float f2) {
		float f3 = MathHelper.cos(entity1.rotationYaw * 3.1415927F / 180.0F);
		float f4 = MathHelper.sin(entity1.rotationYaw * 3.1415927F / 180.0F);
		float f5 = -f4 * MathHelper.sin(entity1.rotationPitch * 3.1415927F / 180.0F);
		float f6 = f3 * MathHelper.sin(entity1.rotationPitch * 3.1415927F / 180.0F);
		float f7 = MathHelper.cos(entity1.rotationPitch * 3.1415927F / 180.0F);
