...
public class RenderBlocks {
	...
	public boolean renderBlockTorch(Block block1, int i2, int i3, int i4) {
		...
		double d8 = 0.4000000059604645D;
		double d10 = 0.5D - d8;
		double d12 = 0.20000000298023224D;
		if(i5 == 1) {
	...
	public boolean renderBlockLever(Block block1, int i2, int i3, int i4) {
		...
		for(int i25 = 0; i25 < 8; ++i25) {
			...
			if(i6 < 5) {
				...
				if(i6 == 3) {
					vec3D21[i25].rotateAroundY(3.1415927F);
				}
	...
	public void renderTorchAtAngle(Block block1, double d2, double d4, double d6, double d8, double d10) {
		...
		double d20 = (double)f16 + 0.02734375D;
		double d22 = (double)f18 + 0.0234375D;
		double d24 = (double)f16 + 0.03515625D;
		double d26 = (double)f18 + 0.03125D;
		d2 += 0.5D;
		d6 += 0.5D;
		double d28 = d2 - 0.5D;
		double d30 = d2 + 0.5D;
	...
	public void renderCrossedSquares(Block block1, int i2, double d3, double d5, double d7) {
		...
		double d21 = d3 + 0.5D - 0.44999998807907104D;
		double d23 = d3 + 0.5D + 0.44999998807907104D;
		double d25 = d7 + 0.5D - 0.44999998807907104D;
		double d27 = d7 + 0.5D + 0.44999998807907104D;
