		...
		if(f3 > 0.5F && this.rand.nextInt(100) == 0) {
			...
			if(f2 > 2.0F && f2 < 6.0F && this.rand.nextInt(10) == 0) {
				if(this.onGround) {
					...
					this.motionX = d4 / (double)f8 * 0.5D * 0.800000011920929D + this.motionX * 0.20000000298023224D;
					this.motionZ = d6 / (double)f8 * 0.5D * 0.800000011920929D + this.motionZ * 0.20000000298023224D;
