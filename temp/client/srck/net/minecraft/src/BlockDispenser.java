	...
	private void dispenseItem(World world1, int i2, int i3, int i4, Random random5) {
		...
		if(itemStack12 == null) {
			...
			if(itemStack12.itemID == Item.arrow.shiftedIndex) {
				...
				entityArrow19.setArrowHeading((double)b9, 0.10000000149011612D, (double)b10, 1.1F, 6.0F);
				...
				entityEgg22.setEggHeading((double)b9, 0.10000000149011612D, (double)b10, 1.1F, 6.0F);
				...
				entitySnowball23.setSnowballHeading((double)b9, 0.10000000149011612D, (double)b10, 1.1F, 6.0F);
				...
				entityItem24.motionY = 0.20000000298023224D;
				entityItem24.motionZ = (double)b10 * d20;
				entityItem24.motionX += random5.nextGaussian() * 0.007499999832361937D * 6.0D;
				entityItem24.motionY += random5.nextGaussian() * 0.007499999832361937D * 6.0D;
				entityItem24.motionZ += random5.nextGaussian() * 0.007499999832361937D * 6.0D;
