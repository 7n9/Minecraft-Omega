	...
	protected void attackEntity(Entity entity1, float f2) {
		if(f2 < 10.0F) {
			...
			if(this.attackTime == 0) {
				...
				++entityArrow7.posY;
				double d8 = entity1.posY + (double)entity1.getEyeHeight() - 0.20000000298023224D - entityArrow7.posY;
			...
			this.rotationYaw = (float)(Math.atan2(d5, d3) * 180.0D / 3.1415927410125732D) - 90.0F;
