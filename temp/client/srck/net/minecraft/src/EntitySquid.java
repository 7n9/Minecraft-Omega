	...
	public void onLivingUpdate() {
		...
		if(this.isInWater()) {
			...
			if(this.field_21085_g < 3.1415927F) {
				f1 = this.field_21085_g / 3.1415927F;
				this.field_21083_i = MathHelper.sin(f1 * f1 * 3.1415927F) * 3.1415927F * 0.25F;
				if((double)f1 > 0.75D) {
			...
			this.field_21089_a += (-((float)Math.atan2((double)f1, this.motionY)) * 180.0F / 3.1415927F - this.field_21089_a) * 0.1F;
		} else {
