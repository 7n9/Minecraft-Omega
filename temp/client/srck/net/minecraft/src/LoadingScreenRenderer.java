	...
	public void setLoadingProgress(int i1) {
		if(!this.mc.running) {
			...
			if(j2 - this.field_1006_d >= 20L) {
				...
				this.mc.fontRenderer.drawStringWithShadow(this.field_1007_c, (i5 - this.mc.fontRenderer.getStringWidth(this.field_1007_c)) / 2, i6 / 2 - 4 - 16, 16777215);
				this.mc.fontRenderer.drawStringWithShadow(this.field_1004_a, (i5 - this.mc.fontRenderer.getStringWidth(this.field_1004_a)) / 2, i6 / 2 - 4 + 8, 16777215);
				Display.update();
