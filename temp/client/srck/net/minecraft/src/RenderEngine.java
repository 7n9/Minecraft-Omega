...
public class RenderEngine {
	...
	public void setupTexture(BufferedImage bufferedImage1, int i2) {
		...
		GL11.glTexImage2D(3553, 0, 6408, i3, i4, 0, 6408, 5121, this.imageData);
		if(useMipmaps) {
			for(i7 = 1; i7 <= 4; ++i7) {
				i8 = i3 >> i7 - 1;
				i9 = i3 >> i7;
				...
				GL11.glTexImage2D(3553, i7, 6408, i9, i10, 0, 6408, 5121, this.imageData);
			}
		}
	...
	public void func_28150_a(int[] i1, int i2, int i3, int i4) {
		...
		GL11.glTexSubImage2D(3553, 0, 0, 0, i2, i3, 6408, 5121, this.imageData);
	}
		...
		for(i1 = 0; i1 < this.textureList.size(); ++i1) {
			...
			for(i3 = 0; i3 < textureFX2.tileSize; ++i3) {
				for(i4 = 0; i4 < textureFX2.tileSize; ++i4) {
					GL11.glTexSubImage2D(3553, 0, textureFX2.iconIndex % 16 * 16 + i3 * 16, textureFX2.iconIndex / 16 * 16 + i4 * 16, 16, 16, 6408, 5121, this.imageData);
					if(useMipmaps) {
						for(i5 = 1; i5 <= 4; ++i5) {
							i6 = 16 >> i5 - 1;
							i7 = 16 >> i5;
							...
							GL11.glTexSubImage2D(3553, i5, textureFX2.iconIndex % 16 * i7, textureFX2.iconIndex / 16 * i7, i7, i7, 6408, 5121, this.imageData);
						}
					}
				}
			}
			...
			if(textureFX2.textureId > 0) {
				...
				if(useMipmaps) {
					for(i3 = 1; i3 <= 4; ++i3) {
						...
						GL11.glTexSubImage2D(3553, i3, 0, 0, i5, i5, 6408, 5121, this.imageData);
					}
				}
			}
		}
