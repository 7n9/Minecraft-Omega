...
public class ModelBiped extends ModelBase {
	...
	public void setRotationAngles(float f1, float f2, float f3, float f4, float f5, float f6) {
		...
		this.bipedRightArm.rotateAngleX = MathHelper.cos(f1 * 0.6662F + 3.1415927F) * 2.0F * f2 * 0.5F;
		...
		this.bipedLeftLeg.rotateAngleX = MathHelper.cos(f1 * 0.6662F + 3.1415927F) * 1.4F * f2;
		...
		if(this.onGround > -9990.0F) {
			...
			this.bipedBody.rotateAngleY = MathHelper.sin(MathHelper.sqrt_float(f7) * 3.1415927F * 2.0F) * 0.2F;
			...
			f7 *= f7;
			f7 = 1.0F - f7;
			float f8 = MathHelper.sin(f7 * 3.1415927F);
			float f9 = MathHelper.sin(this.onGround * 3.1415927F) * -(this.bipedHead.rotateAngleX - 0.7F) * 0.75F;
