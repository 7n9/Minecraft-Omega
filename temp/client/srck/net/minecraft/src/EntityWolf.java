...
public class EntityWolf extends EntityAnimal {
	...
	public void onUpdate() {
		...
		if(this.isWet()) {
			...
			if(this.timeWolfIsShaking > 0.4F) {
				...
				int i2 = (int)(MathHelper.sin((this.timeWolfIsShaking - 0.4F) * 3.1415927F) * 7.0F);
	...
	public float getInterestedAngle(float f1) {
		return (this.field_25054_c + (this.field_25048_b - this.field_25054_c) * f1) * 0.15F * 3.1415927F;
	}
	...
	protected void attackEntity(Entity entity1, float f2) {
		if(f2 > 2.0F && f2 < 6.0F && this.rand.nextInt(10) == 0) {
			if(this.onGround) {
				...
				this.motionX = d8 / (double)f7 * 0.5D * 0.800000011920929D + this.motionX * 0.20000000298023224D;
				this.motionZ = d5 / (double)f7 * 0.5D * 0.800000011920929D + this.motionZ * 0.20000000298023224D;
