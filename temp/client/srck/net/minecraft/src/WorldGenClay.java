...
public class WorldGenClay extends WorldGenerator {
	...
	public boolean generate(World world1, Random random2, int i3, int i4, int i5) {
		if(world1.getBlockMaterial(i3, i4, i5) != Material.water) {
			...
			float f6 = random2.nextFloat() * 3.1415927F;
			...
			for(int i19 = 0; i19 <= this.numberOfBlocks; ++i19) {
				...
				double d28 = (double)(MathHelper.sin((float)i19 * 3.1415927F / (float)this.numberOfBlocks) + 1.0F) * d26 + 1.0D;
				double d30 = (double)(MathHelper.sin((float)i19 * 3.1415927F / (float)this.numberOfBlocks) + 1.0F) * d26 + 1.0D;
