...
abstract class GuiSlotStats extends GuiSlot {
	...
	protected void func_27265_a(StatCrafting statCrafting1, int i2, int i3, boolean z4) {
		...
		if(statCrafting1 != null) {
			...
			this.field_27269_g.drawString(GuiStats.func_27133_h(this.field_27269_g), string5, i2 - GuiStats.func_27137_i(this.field_27269_g).getStringWidth(string5), i3 + 5, z4 ? 16777215 : 9474192);
		} else {
			string5 = "-";
			this.field_27269_g.drawString(GuiStats.func_27132_j(this.field_27269_g), string5, i2 - GuiStats.func_27134_k(this.field_27269_g).getStringWidth(string5), i3 + 5, z4 ? 16777215 : 9474192);
		}
