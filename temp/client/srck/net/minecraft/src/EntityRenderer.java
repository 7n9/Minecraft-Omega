...
public class EntityRenderer {
	...
	private void hurtCameraEffect(float f1) {
		...
		if(f3 >= 0.0F) {
			...
			f3 = MathHelper.sin(f3 * f3 * f3 * f3 * 3.1415927F);
	...
	private void setupViewBobbing(float f1) {
		if(this.mc.renderViewEntity instanceof EntityPlayer) {
			...
			GL11.glTranslatef(MathHelper.sin(f4 * 3.1415927F) * f5 * 0.5F, -Math.abs(MathHelper.cos(f4 * 3.1415927F) * f5), 0.0F);
			GL11.glRotatef(MathHelper.sin(f4 * 3.1415927F) * f5 * 3.0F, 0.0F, 0.0F, 1.0F);
			GL11.glRotatef(Math.abs(MathHelper.cos(f4 * 3.1415927F - 0.2F) * f5) * 5.0F, 1.0F, 0.0F, 0.0F);
	...
	private void orientCamera(float f1) {
		...
		if(entityLiving2.isPlayerSleeping()) {
			...
			if(this.mc.gameSettings.field_22273_E) {
				...
				double d14 = (double)(-MathHelper.sin(f28 / 180.0F * 3.1415927F) * MathHelper.cos(f13 / 180.0F * 3.1415927F)) * d27;
				double d16 = (double)(MathHelper.cos(f28 / 180.0F * 3.1415927F) * MathHelper.cos(f13 / 180.0F * 3.1415927F)) * d27;
				double d18 = (double)(-MathHelper.sin(f13 / 180.0F * 3.1415927F)) * d27;
