...
public class TextureCompassFX extends TextureFX {
	...
	public void onTick() {
		...
		if(this.mc.theWorld != null && this.mc.thePlayer != null) {
			...
			d20 = (double)(this.mc.thePlayer.rotationYaw - 90.0F) * 3.141592653589793D / 180.0D - Math.atan2(d25, d23);
			if(this.mc.theWorld.worldProvider.isNether) {
				d20 = Math.random() * 3.1415927410125732D * 2.0D;
			}
		}

		double d22;
		for(d22 = d20 - this.field_4229_i; d22 < -3.141592653589793D; d22 += 6.283185307179586D) {
		}

		while(d22 >= 3.141592653589793D) {
