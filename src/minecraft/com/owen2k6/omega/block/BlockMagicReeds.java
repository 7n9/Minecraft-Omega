...
public class BlockMagicReeds extends Block {
	...
	public boolean canPlaceBlockAt(World world1, int i2, int i3, int i4) {
		...
		return i5 == this.blockID || ((i5 == Block.grass.blockID || i5 == Block.dirt.blockID || i5 == Block.sand.blockID) && (world1.getBlockMaterial(i2 - 1, i3 - 1, i4) == Material.water || (world1.getBlockMaterial(i2 + 1, i3 - 1, i4) == Material.water || (world1.getBlockMaterial(i2, i3 - 1, i4 - 1) == Material.water || world1.getBlockMaterial(i2, i3 - 1, i4 + 1) == Material.water))));
	}
	...
	public int idDropped(int i1, Random random2) {
		return Item.magicreed.shiftedIndex;
	}
