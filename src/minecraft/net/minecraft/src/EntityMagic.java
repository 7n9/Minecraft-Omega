...
public class EntityMagic extends Entity {
	...
	public EntityMagic(World world1) {
		super(world1);
		this.setSize(0.5F, 0.5F);
	}

	public EntityMagic(World world1, double d2, double d4, double d6) {
		super(world1);
		this.setSize(0.5F, 0.5F);
	...
	public EntityMagic(World world1, EntityLiving entityLiving2) {
		super(world1);
