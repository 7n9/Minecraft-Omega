...
public class RenderSquid extends RenderLiving {
	...
	protected void func_21007_a(EntitySquid entitySquid1, float f3, float f4) {
	...
	protected void func_21005_a() {
	}

	protected float func_21006_b(EntitySquid entitySquid1, float f2) {
		return entitySquid1.field_21082_j + (entitySquid1.field_21083_i - entitySquid1.field_21082_j) * f2;
	}
	...
	protected void rotateCorpse(EntityLiving entityLiving1, float f2, float f3, float f4) {
		this.func_21007_a((EntitySquid)entityLiving1, f3, f4);
	}
