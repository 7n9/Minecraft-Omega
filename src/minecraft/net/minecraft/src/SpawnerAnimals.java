...
public final class SpawnerAnimals {
	...
	protected static ChunkPosition getRandomSpawningPointInChunk(World world0, int i1, int i2) {
		...
		int i4 = world0.rand.nextInt(world0.getHeight());
	...
	public static boolean performSleepSpawning(World world0, List list1) {
		...
		while(true) {
			...
			for(int i8 = 0; i8 < 20 && !z7; ++i8) {
				...
				if(i11 < 1) {
					i11 = 1;
				} else if(i11 > world0.getHeight()) {
					i11 = world0.getHeight();
				}
				...
				while(!canCreatureTypeSpawnAtLocation(EnumCreatureType.monster, world0, i9, i13, i10) && i13 < i11 + 16 && i13 < world0.getHeight()) {
					++i13;
				}

				if(i13 < i11 + 16 && i13 < world0.getHeight()) {
