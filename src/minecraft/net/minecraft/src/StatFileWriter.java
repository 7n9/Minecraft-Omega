...
public class StatFileWriter {
	...
	private void writeStatToMap(Map map1, StatBase statBase2, int i3) {
		...
		int i5 = integer4 == null ? 0 : integer4;
	...
	public static Map func_27177_a(String string0) {
		...
		try {
			...
			List list5 = j_JsonRootNode4.func_27217_b("stats-change");

			for (Object o : list5) {
				J_JsonNode j_JsonNode7 = (J_JsonNode) o;
			...
			if(!string15.equals(j_JsonRootNode4.func_27213_a("checksum"))) {
