...
public class MapGenRavine extends MapGenBase {
	...
	protected void generateRavine(long j1, int i3, int i4, byte[] b5, double d6, double d8, double d10, float f12, float f13, float f14, int i15, int i16, double d17) {
		...
		float f25 = 0.0F;
		if(i16 <= 0) {
			int i26 = this.field_1306_a * 16 - 16;
		...
		for(int i28 = 0; i28 < this.worldObj.depth; ++i28) {
		...
		for(; i15 < i16; ++i15) {
			...
			if(z53 || random19.nextInt(4) != 0) {
				...
				if(d6 >= d20 - 16.0D - d54 * 2.0D && d10 >= d22 - 16.0D - d54 * 2.0D && d6 <= d20 + 16.0D + d54 * 2.0D && d10 <= d22 + 16.0D + d54 * 2.0D) {
					...
					if(i37 > this.worldObj.depth - 8) {
						i37 = this.worldObj.depth - 8;
					}
					...
					for(i41 = i55; !z58 && i41 < i35; ++i41) {
						for(int i42 = i57; !z58 && i42 < i39; ++i42) {
							for(int i43 = i37 + 1; !z58 && i43 >= i56 - 1; --i43) {
								i44 = (i41 * 16 + i42) * this.worldObj.depth + i43;
								if(i43 >= 0 && i43 < this.worldObj.depth) {
					...
					if(!z58) {
						for(i41 = i55; i41 < i35; ++i41) {
							...
							for(i44 = i57; i44 < i39; ++i44) {
								...
								int i47 = (i41 * 16 + i44) * this.worldObj.depth + i37;
								boolean z48 = false;
								if(d59 * d59 + d45 * d45 < 1.0D) {
									for(int i49 = i37 - 1; i49 >= i56; --i49) {
										double d50 = ((double)i49 + 0.5D - d8) / d30;
										if((d59 * d59 + d45 * d45) * (double)this.rs[i49] + d50 * d50 / 6.0D < 1.0D) {
											byte b52 = b5[i47];
											...
											if(b52 == Block.stone.blockID || b52 == Block.dirt.blockID || b52 == Block.grass.blockID) {
												if(i49 < 10) {
													...
													if(z48 && b5[i47 - 1] == Block.dirt.blockID) {
														b5[i47 - 1] = this.worldObj.getWorldChunkManager().getBiomeGenAt(i41 + i3 * 16, i44 + i4 * 16).topBlock;
													}
												}
											}
										}
