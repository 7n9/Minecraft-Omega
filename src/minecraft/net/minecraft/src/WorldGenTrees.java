	...
	public boolean generate(World world1, Random random2, int i3, int i4, int i5) {
		...
		if(i4 >= 1 && i4 + i6 + 1 <= world1.depth) {
			...
			if(!z7) {
				...
				if((i8 == Block.grass.blockID || i8 == Block.dirt.blockID) && i4 < world1.depth - i6 - 1) {
							...
							for(int i14 = i5 - i11; i14 <= i5 + i11; ++i14) {
								...
								if(Math.abs(i13) != i11 || Math.abs(i15) != i11 || random2.nextInt(2) != 0 && i10 != 0) {
									...
									if(i18 == 0 || i18 == Block.leaves.blockID) {
										this.setBlockAndMetadata(world1, i12, i16, i14, Block.leaves.blockID, 0);
									}
								}
							}
						}
					...
					for(i16 = 0; i16 < i6; ++i16) {
						...
						if(i10 == 0 || i10 == Block.leaves.blockID) {
							this.setBlockAndMetadata(world1, i3, i4 + i16, i5, Block.wood.blockID, 0);
						}
					}
