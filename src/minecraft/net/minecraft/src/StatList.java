...
public class StatList {
	protected static Map<Integer, StatBase> field_25169_C = new HashMap<Integer, StatBase>();
	public static List<StatBase> field_25188_a = new ArrayList<StatBase>();
	public static List<StatBasic> field_25187_b = new ArrayList<StatBasic>();
	...
	public static StatBase[] mineBlockStatArray = func_25153_a();
	...
	public static void func_25154_a() {
		...
		field_25170_B = func_25149_b(field_25170_B, 16973824, 0, Block.blocksList.length);
		field_25166_D = true;
		func_25157_c();
	}
	...
	public static void func_25151_b() {
		...
		field_25170_B = func_25149_b(field_25170_B, 16973824, Block.blocksList.length, 32000);
		field_25164_E = true;
		func_25157_c();
	}
	...
	public static void func_25157_c() {
		if(field_25166_D && field_25164_E) {
			...
			while(iterator1.hasNext()) {
				...
				if(Item.itemsList[integer5] != null) {
					String string3 = StatCollector.translateToLocalFormatted("stat.craftItem", Item.itemsList[integer5].getStatName());
					field_25158_z[integer5] = (new StatCrafting(16842752 + integer5, string3, integer5)).registerStat();
				}
			}
	...
	private static StatBase[] func_25153_a() {
		StatBase[] statBase2 = new StatBase[256];

		for(int i3 = 0; i3 < 256; ++i3) {
			if(Block.blocksList[i3] != null && Block.blocksList[i3].getEnableStats()) {
				String string4 = StatCollector.translateToLocalFormatted("stat.mineBlock", Block.blocksList[i3].translateBlockName());
				statBase2[i3] = (new StatCrafting(16777216 + i3, string4, i3)).registerStat();
	...
	private static StatBase[] func_25155_a(StatBase[] statBase0, String string1, int i2, int i3, int i4) {
		...
		for(int i5 = i3; i5 < i4; ++i5) {
			if(Item.itemsList[i5] != null) {
				String string6 = StatCollector.translateToLocalFormatted(string1, Item.itemsList[i5].getStatName());
	...
	private static StatBase[] func_25149_b(StatBase[] statBase0, int i2, int i3, int i4) {
		if(statBase0 == null) {
			statBase0 = new StatBase[32000];
		}
		...
		for(int i5 = i3; i5 < i4; ++i5) {
			if(Item.itemsList[i5] != null && Item.itemsList[i5].isDamagable()) {
				String string6 = StatCollector.translateToLocalFormatted("stat.breakItem", Item.itemsList[i5].getStatName());
				statBase0[i5] = (new StatCrafting(i2 + i5, string6, i5)).registerStat();
			}
		}
