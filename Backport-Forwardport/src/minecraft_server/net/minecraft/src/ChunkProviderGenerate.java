...
public class ChunkProviderGenerate implements IChunkProvider {
	...
	public void generateTerrain(int i1, int i2, byte[] b3) {
		...
		int i8 = 128 / 8 + 1;
		int i9 = b4 + 1;
		this.biomesForGeneration = this.worldObj.getWorldChunkManager().func_35142_b(this.biomesForGeneration, i1 * 4 - 2, i2 * 4 - 2, i7 + 5, i9 + 5);
		this.field_4224_q = this.func_4058_a(this.field_4224_q, i1 * b4, 0, i2 * b4, i7, i8, i9);

		for(int i10 = 0; i10 < b4; ++i10) {
			for(int i11 = 0; i11 < b4; ++i11) {
				for(int i12 = 0; i12 < i5; ++i12) {
					double d13 = 0.125D;
					double d15 = this.field_4224_q[((i10 + 0) * i9 + i11 + 0) * i8 + i12 + 0];
					double d17 = this.field_4224_q[((i10 + 0) * i9 + i11 + 1) * i8 + i12 + 0];
					double d19 = this.field_4224_q[((i10 + 1) * i9 + i11 + 0) * i8 + i12 + 0];
					double d21 = this.field_4224_q[((i10 + 1) * i9 + i11 + 1) * i8 + i12 + 0];
					double d23 = (this.field_4224_q[((i10 + 0) * i9 + i11 + 0) * i8 + i12 + 1] - d15) * d13;
					double d25 = (this.field_4224_q[((i10 + 0) * i9 + i11 + 1) * i8 + i12 + 1] - d17) * d13;
					double d27 = (this.field_4224_q[((i10 + 1) * i9 + i11 + 0) * i8 + i12 + 1] - d19) * d13;
					double d29 = (this.field_4224_q[((i10 + 1) * i9 + i11 + 1) * i8 + i12 + 1] - d21) * d13;
	...
	public void replaceBlocksForBiome(int i1, int i2, byte[] b3, BiomeGenBase[] biomeGenBase4) {
		...
		byte b5 = 63;
		double d6 = 8.0D / 256D;
		this.field_35562_v = this.field_702_n.generateNoiseOctaves(this.field_35562_v, i1 * 16, i2 * 16, 0, 16, 16, 1, d6 * 2.0D, d6 * 2.0D, d6 * 2.0D);

		for(int i8 = 0; i8 < 16; ++i8) {
			for(int i9 = 0; i9 < 16; ++i9) {
				BiomeGenBase biomeGenBase10 = biomeGenBase4[i9 + i8 * 16];
				int i11 = (int)(this.field_35562_v[i8 + i9 * 16] / 3.0D + 3.0D + this.rand.nextDouble() * 0.25D);
				int i12 = -1;
	...
	public Chunk provideChunk(int i1, int i2) {
		...
		if(this.field_35563_t) {
			this.field_35559_d.generate(this, this.worldObj, i1, i2, b3);
			this.field_35558_f.generate(this, this.worldObj, i1, i2, b3);
			this.field_35560_e.generate(this, this.worldObj, i1, i2, b3);
		}

		this.field_35564_x.generate(this, this.worldObj, i1, i2, b3);
	...
	private double[] func_4058_a(double[] d1, int i2, int i3, int i4, int i5, int i6, int i7) {
		...
		this.field_4229_d = this.field_703_m.generateNoiseOctaves(this.field_4229_d, i2, i3, i4, i5, i6, i7, d44 / 80.0D, d45 / 160.0D, d44 / 80.0D);
		this.field_4228_e = this.field_705_k.generateNoiseOctaves(this.field_4228_e, i2, i3, i4, i5, i6, i7, d44, d45, d44);
		this.field_4227_f = this.field_704_l.generateNoiseOctaves(this.field_4227_f, i2, i3, i4, i5, i6, i7, d44, d45, d44);
		boolean z43 = false;
		boolean z42 = false;
		int i12 = 0;
		int i13 = 0;
			...
			for(int i15 = 0; i15 < i7; ++i15) {
				...
				for(int i21 = -b19; i21 <= b19; ++i21) {
					for(int i22 = -b19; i22 <= b19; ++i22) {
						...
						float f24 = this.field_35561_l[i21 + 2 + (i22 + 2) * 5] / (biomeGenBase23.field_35527_q + 2.0F);
						if(biomeGenBase23.field_35527_q > biomeGenBase20.field_35527_q) {
							f24 /= 2.0F;
						}

						f16 += biomeGenBase23.field_35526_r * f24;
						f17 += biomeGenBase23.field_35527_q * f24;
						f18 += f24;
					}
				}
				...
				double d46 = this.field_4225_h[i13] / 8000.0D;
				if(d46 < 0.0D) {
					d46 = -d46 * 0.3D;
				}
				...
				for(int i47 = 0; i47 < i6; ++i47) {
					...
					double d34 = this.field_4228_e[i12] / 512.0D;
					double d36 = this.field_4227_f[i12] / 512.0D;
					double d38 = (this.field_4229_d[i12] / 10.0D + 1.0D) / 2.0D;
					if(d38 < 0.0D) {
						d30 = d34;
					} else if(d38 > 1.0D) {
						d30 = d36;
	...
	public void populate(IChunkProvider iChunkProvider1, int i2, int i3) {
		...
		boolean z11 = false;
		if(this.field_35563_t) {
			this.field_35559_d.func_35532_a(this.worldObj, this.rand, i2, i3);
			this.field_35558_f.func_35532_a(this.worldObj, this.rand, i2, i3);
			z11 = this.field_35560_e.func_35532_a(this.worldObj, this.rand, i2, i3);
		}
		...
		biomeGenBase6.func_35513_a(this.worldObj, this.rand, i4, i5);
		SpawnerAnimals.func_35573_a(this.worldObj, biomeGenBase6, i4 + 8, i5 + 8, 16, 16, this.rand);
