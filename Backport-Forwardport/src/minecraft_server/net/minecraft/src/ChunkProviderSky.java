...
public class ChunkProviderSky implements IChunkProvider {
	...
	public void generateTerrain(int i1, int i2, byte[] b3, BiomeGenBase[] biomeGenBase4) {
		...
		int i7 = 128 / 4 + 1;
		int i8 = b5 + 1;
		this.field_28078_q = this.func_28071_a(this.field_28078_q, i1 * b5, 0, i2 * b5, i6, i7, i8);
		...
		for(int i9 = 0; i9 < b5; ++i9) {
			for(int i10 = 0; i10 < b5; ++i10) {
				...
				while(true) {
					...
					double d12 = 0.25D;
					double d14 = this.field_28078_q[((i9 + 0) * i8 + i10 + 0) * i7 + i11 + 0];
					double d16 = this.field_28078_q[((i9 + 0) * i8 + i10 + 1) * i7 + i11 + 0];
					double d18 = this.field_28078_q[((i9 + 1) * i8 + i10 + 0) * i7 + i11 + 0];
					double d20 = this.field_28078_q[((i9 + 1) * i8 + i10 + 1) * i7 + i11 + 0];
					double d22 = (this.field_28078_q[((i9 + 0) * i8 + i10 + 0) * i7 + i11 + 1] - d14) * d12;
					double d24 = (this.field_28078_q[((i9 + 0) * i8 + i10 + 1) * i7 + i11 + 1] - d16) * d12;
					double d26 = (this.field_28078_q[((i9 + 1) * i8 + i10 + 0) * i7 + i11 + 1] - d18) * d12;
					double d28 = (this.field_28078_q[((i9 + 1) * i8 + i10 + 1) * i7 + i11 + 1] - d20) * d12;
	...
	public void replaceBlocksForBiome(int i1, int i2, byte[] b3, BiomeGenBase[] biomeGenBase4) {
		double d5 = 8.0D / 256D;
		this.unusedSandNoise = this.field_28081_n.generateNoiseOctaves(this.unusedSandNoise, i1 * 16, i2 * 16, 0, 16, 16, 1, d5, d5, 1.0D);
		this.unusedGravelNoise = this.field_28081_n.generateNoiseOctaves(this.unusedGravelNoise, i1 * 16, 109, i2 * 16, 16, 1, 16, d5, 1.0D, d5);
		this.stoneNoise = this.field_28080_o.generateNoiseOctaves(this.stoneNoise, i1 * 16, i2 * 16, 0, 16, 16, 1, d5 * 2.0D, d5 * 2.0D, d5 * 2.0D);
	...
	public Chunk provideChunk(int i1, int i2) {
		...
		this.field_28073_v = this.worldObj.getWorldChunkManager().loadBlockGeneratorData(this.field_28073_v, i1 * 16, i2 * 16, 16, 16);
		this.generateTerrain(i1, i2, b3, this.field_28073_v);
		this.replaceBlocksForBiome(i1, i2, b3, this.field_28073_v);
	...
	private double[] func_28071_a(double[] d1, int i2, int i3, int i4, int i5, int i6, int i7) {
		...
		d8 *= 2.0D;
		this.field_28091_d = this.field_28082_m.generateNoiseOctaves(this.field_28091_d, i2, i3, i4, i5, i6, i7, d8 / 80.0D, d10 / 160.0D, d8 / 80.0D);
		this.field_28090_e = this.field_28084_k.generateNoiseOctaves(this.field_28090_e, i2, i3, i4, i5, i6, i7, d8, d10, d8);
		this.field_28089_f = this.field_28083_l.generateNoiseOctaves(this.field_28089_f, i2, i3, i4, i5, i6, i7, d8, d10, d8);
		int i12 = 0;
		int i13 = 0;

		for(int i14 = 0; i14 < i5; ++i14) {
			for(int i15 = 0; i15 < i7; ++i15) {
				double d16 = (this.field_28088_g[i13] + 256.0D) / 512.0D;
				if(d16 > 1.0D) {
					d16 = 1.0D;
				}

				double d18 = this.field_28087_h[i13] / 8000.0D;
				if(d18 < 0.0D) {
					d18 = -d18 * 0.3D;
				}
				...
				for(int i22 = 0; i22 < i6; ++i22) {
					...
					double d27 = this.field_28090_e[i12] / 512.0D;
					double d29 = this.field_28089_f[i12] / 512.0D;
					double d31 = (this.field_28091_d[i12] / 10.0D + 1.0D) / 2.0D;
					if(d31 < 0.0D) {
						d23 = d27;
					} else if(d31 > 1.0D) {
						d23 = d29;
	...
	public void populate(IChunkProvider iChunkProvider1, int i2, int i3) {
		...
		d11 = 0.5D;
		i13 = (int)((this.field_28092_c.func_647_a((double)i4 * d11, (double)i5 * d11) / 8.0D + this.random.nextDouble() * 4.0D + 4.0D) / 3.0D);
		i14 = 0;
		...
		if(biomeGenBase6 == BiomeGenBase.field_35520_c) {
			i14 -= 20;
		}
