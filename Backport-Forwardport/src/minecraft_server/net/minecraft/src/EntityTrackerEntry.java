			...
			if(d2 >= (double)(-this.trackingDistanceThreshold) && d2 <= (double)this.trackingDistanceThreshold && d4 >= (double)(-this.trackingDistanceThreshold) && d4 <= (double)this.trackingDistanceThreshold) {
				if(!this.trackedPlayers.contains(entityPlayerMP1)) {
					...
					if(this.trackedEntity instanceof EntityLiving) {
						...
						Iterator iterator8 = entityLiving11.func_35183_ak().iterator();
	...
	private Packet getSpawnPacket() {
		if(this.trackedEntity instanceof EntityItem) {
			...
			if(this.trackedEntity instanceof EntityBoat) {
				...
				Entity entity5 = ((EntityArrow)this.trackedEntity).shootingEntity;
				return new Packet23VehicleSpawn(this.trackedEntity, 60, entity5 != null ? entity5.entityId : this.trackedEntity.entityId);
				...
				packet23VehicleSpawn2.field_28044_e = (int)(entityFireball4.accelerationX * 8000.0D);
				packet23VehicleSpawn2.field_28043_f = (int)(entityFireball4.accelerationY * 8000.0D);
				packet23VehicleSpawn2.field_28042_g = (int)(entityFireball4.accelerationZ * 8000.0D);
