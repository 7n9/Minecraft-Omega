	...
	public void onUpdate() {
		...
		if(this.worldObj.singleplayerWorld) {
			if(this.field_9176_d > 0) {
				d21 = this.posX + (this.boatX - this.posX) / (double)this.field_9176_d;
				d6 = this.posY + (this.boatY - this.posY) / (double)this.field_9176_d;
				d8 = this.posZ + (this.boatZ - this.posZ) / (double)this.field_9176_d;
