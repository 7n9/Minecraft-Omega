...
public final class ItemStack {
	...
	public static ItemStack func_35618_a(NBTTagCompound nBTTagCompound0) {
	...
	public ItemStack func_35617_b(World world1, EntityPlayer entityPlayer2) {
		return this.getItem().func_35405_b(this, world1, entityPlayer2);
	}
	...
	public void func_35613_a(World world1, EntityPlayer entityPlayer2, int i3) {
		this.getItem().func_35408_a(this, world1, entityPlayer2, i3);
	}
}
