...
public class NetServerHandler extends NetHandler implements ICommandListener {
	...
	public void handleMovementTypePacket(Packet27Position packet27Position1) {
		this.playerEntity.setMovementType(packet27Position1.getStrafeMovement(), packet27Position1.getForwardMovement(), packet27Position1.func_22032_g(), packet27Position1.isInJump(), packet27Position1.getPitchRotation(), packet27Position1.getYawRotation());
	}
	...
	public void handleFlying(Packet10Flying packet10Flying1) {
		...
		if(this.hasMoved) {
			...
			boolean z23 = false;
			if(d19 > 0.0625D && !this.playerEntity.isPlayerSleeping() && !this.playerEntity.itemInWorldManager.func_35698_b()) {
				z23 = true;
			...
			boolean z24 = worldServer2.getCollidingBoundingBoxes(this.playerEntity, this.playerEntity.boundingBox.copy().contract((double)f21, (double)f21, (double)f21)).size() == 0;
			...
			if(!this.mcServer.allowFlight && !this.playerEntity.itemInWorldManager.func_35698_b() && !worldServer2.func_27069_b(axisAlignedBB25)) {
				if(d15 >= -0.03125D) {
	...
	public void handleBlockDig(Packet14BlockDig packet14BlockDig1) {
		...
		if(packet14BlockDig1.status == 4) {
			...
			int i9 = MathHelper.func_35475_a(i5 - chunkCoordinates19.posX);
			int i20 = MathHelper.func_35475_a(i7 - chunkCoordinates19.posZ);
			if(i9 > i20) {
				i20 = i9;
			}
	...
	public void handlePlace(Packet15Place packet15Place1) {
		...
		if(packet15Place1.direction == 255) {
			...
			int i10 = MathHelper.func_35475_a(i5 - chunkCoordinates9.posX);
			int i11 = MathHelper.func_35475_a(i7 - chunkCoordinates9.posZ);
			if(i10 > i11) {
				i11 = i10;
			}
		...
		if(itemStack3 == null || itemStack3.func_35614_l() == 0) {
	...
	public void handleWindowClick(Packet102WindowClick packet102WindowClick1) {
		if(this.playerEntity.currentCraftingInventory.windowId == packet102WindowClick1.window_Id && this.playerEntity.currentCraftingInventory.getCanCraft(this.playerEntity)) {
			ItemStack itemStack2 = this.playerEntity.currentCraftingInventory.slotClick(packet102WindowClick1.inventorySlot, packet102WindowClick1.mouseClick, packet102WindowClick1.holdingShift, this.playerEntity);
			if(ItemStack.areItemStacksEqual(packet102WindowClick1.itemStack, itemStack2)) {
				...
				this.field_10_k.addKey(this.playerEntity.currentCraftingInventory.windowId, packet102WindowClick1.action);
	...
	public void func_35004_a(Packet107CreativeSetSlot packet107CreativeSetSlot1) {
		if(this.playerEntity.itemInWorldManager.func_35698_b()) {
			boolean z2 = packet107CreativeSetSlot1.field_35108_a >= 36 && packet107CreativeSetSlot1.field_35108_a < 36 + InventoryPlayer.func_25054_e();
			boolean z3 = packet107CreativeSetSlot1.field_35106_b >= -1 && packet107CreativeSetSlot1.field_35106_b < Item.itemsList.length && (packet107CreativeSetSlot1.field_35106_b < 0 || Item.itemsList[packet107CreativeSetSlot1.field_35106_b] != null);
			boolean z4 = packet107CreativeSetSlot1.field_35105_d >= 0 && packet107CreativeSetSlot1.field_35107_c >= 0 && packet107CreativeSetSlot1.field_35107_c <= 64;
			if(z2 && z3 && z4) {
				if(packet107CreativeSetSlot1.field_35106_b <= 0) {
					this.playerEntity.personalCraftingInventory.func_35498_a(packet107CreativeSetSlot1.field_35108_a, (ItemStack)null);
				} else {
					this.playerEntity.personalCraftingInventory.func_35498_a(packet107CreativeSetSlot1.field_35108_a, new ItemStack(packet107CreativeSetSlot1.field_35106_b, packet107CreativeSetSlot1.field_35107_c, packet107CreativeSetSlot1.field_35105_d));
				}

				this.playerEntity.personalCraftingInventory.setCanCraft(this.playerEntity, true);
			} else if(!z2 && z3 && z4 && packet107CreativeSetSlot1.field_35108_a == -1 && packet107CreativeSetSlot1.field_35106_b > 0) {
				this.playerEntity.dropPlayerItem(new ItemStack(packet107CreativeSetSlot1.field_35106_b, packet107CreativeSetSlot1.field_35107_c, packet107CreativeSetSlot1.field_35105_d));
			}
		}
	...
	public void handleTransaction(Packet106Transaction packet106Transaction1) {
		Short short2 = (Short)this.field_10_k.lookup(this.playerEntity.currentCraftingInventory.windowId);
	...
	public void func_35005_a(Packet0KeepAlive packet0KeepAlive1) {
		if(packet0KeepAlive1.field_35126_a == this.field_35013_i) {
			int i2 = (int)(System.nanoTime() / 1000000L - this.field_35011_j);
			this.playerEntity.field_35219_i = (this.playerEntity.field_35219_i * 3 + i2) / 4;
		}
