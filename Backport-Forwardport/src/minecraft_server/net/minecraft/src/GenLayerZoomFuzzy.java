...
public class GenLayerZoomFuzzy extends GenLayer {
	...
	public int[] func_35018_a(int i1, int i2, int i3, int i4) {
		...
		for(int i12 = 0; i12 < i8 - 1; ++i12) {
			...
			for(int i17 = 0; i17 < i7 - 1; ++i17) {
				...
				i10[i14] = i15;
				i10[i14++ + i11] = this.func_35032_a(i15, i16);
				i10[i14] = this.func_35032_a(i15, i18);
				i10[i14++ + i11] = this.func_35031_b(i15, i18, i16, i19);
				i15 = i18;
				i16 = i19;
			}
		}
	...
	protected int func_35032_a(int i1, int i2) {
		return this.func_35016_a(2) == 0 ? i1 : i2;
	}

	protected int func_35031_b(int i1, int i2, int i3, int i4) {
