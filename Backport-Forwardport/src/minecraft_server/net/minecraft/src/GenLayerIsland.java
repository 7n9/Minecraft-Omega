...
public class GenLayerIsland extends GenLayer {
	...
	public int[] func_35018_a(int i1, int i2, int i3, int i4) {
		...
		int[] i10 = IntCache.func_35549_a(i3 * i4);
		...
		for(int i11 = 0; i11 < i4; ++i11) {
			for(int i12 = 0; i12 < i3; ++i12) {
				...
				this.func_35017_a((long)(i12 + i1), (long)(i11 + i2));
				if(i17 == 0 && (i13 != 0 || i14 != 0 || i15 != 0 || i16 != 0)) {
					i10[i12 + i11 * i3] = 0 + this.func_35016_a(3) / 2;
				} else if(i17 != 1 || i13 == 1 && i14 == 1 && i15 == 1 && i16 == 1) {
					i10[i12 + i11 * i3] = i17;
				} else {
					i10[i12 + i11 * i3] = 1 - this.func_35016_a(5) / 4;
				}
			}
		}
