...
public class ChunkProviderHell implements IChunkProvider {
	...
	public void func_4062_a(int i1, int i2, byte[] b3) {
		...
		int i7 = 128 / 8 + 1;
		int i8 = b4 + 1;
		this.field_4234_o = this.func_4060_a(this.field_4234_o, i1 * b4, 0, i2 * b4, i6, i7, i8);
		...
		for(int i9 = 0; i9 < b4; ++i9) {
			for(int i10 = 0; i10 < b4; ++i10) {
				...
				while(true) {
					...
					double d12 = 0.125D;
					double d14 = this.field_4234_o[((i9 + 0) * i8 + i10 + 0) * i7 + i11 + 0];
					double d16 = this.field_4234_o[((i9 + 0) * i8 + i10 + 1) * i7 + i11 + 0];
					double d18 = this.field_4234_o[((i9 + 1) * i8 + i10 + 0) * i7 + i11 + 0];
					double d20 = this.field_4234_o[((i9 + 1) * i8 + i10 + 1) * i7 + i11 + 0];
					double d22 = (this.field_4234_o[((i9 + 0) * i8 + i10 + 0) * i7 + i11 + 1] - d14) * d12;
					double d24 = (this.field_4234_o[((i9 + 0) * i8 + i10 + 1) * i7 + i11 + 1] - d16) * d12;
					double d26 = (this.field_4234_o[((i9 + 1) * i8 + i10 + 0) * i7 + i11 + 1] - d18) * d12;
					double d28 = (this.field_4234_o[((i9 + 1) * i8 + i10 + 1) * i7 + i11 + 1] - d20) * d12;
					...
					for(int i30 = 0; i30 < 8; ++i30) {
						...
						for(int i41 = 0; i41 < 4; ++i41) {
							...
							int i10001 = 0 + i10 * 4;
							this.worldObj.getClass();
							int i42 = i10000 | i10001 << 7 | i11 * 8 + i30;
							this.worldObj.getClass();
							int i43 = 1 << 7;
							double d44 = 0.25D;
							double d46 = d33;
	...
	public void func_4061_b(int i1, int i2, byte[] b3) {
		...
		int i4 = 128 - 64;
		double d5 = 8.0D / 256D;
		this.field_4233_p = this.field_4237_l.generateNoiseOctaves(this.field_4233_p, i1 * 16, i2 * 16, 0, 16, 16, 1, d5, d5, 1.0D);
		this.gravelNoise = this.field_4237_l.generateNoiseOctaves(this.gravelNoise, i1 * 16, 109, i2 * 16, 16, 1, 16, d5, 1.0D, d5);
		this.field_4231_r = this.field_4236_m.generateNoiseOctaves(this.field_4231_r, i1 * 16, i2 * 16, 0, 16, 16, 1, d5 * 2.0D, d5 * 2.0D, d5 * 2.0D);
	...
	public Chunk provideChunk(int i1, int i2) {
		...
		this.field_4230_s.generate(this, this.worldObj, i1, i2, b3);
	...
	private double[] func_4060_a(double[] d1, int i2, int i3, int i4, int i5, int i6, int i7) {
		...
		this.field_4243_f = this.field_4248_a.generateNoiseOctaves(this.field_4243_f, i2, i3, i4, i5, 1, i7, 1.0D, 0.0D, 1.0D);
		this.field_4242_g = this.field_4247_b.generateNoiseOctaves(this.field_4242_g, i2, i3, i4, i5, 1, i7, 100.0D, 0.0D, 100.0D);
		this.field_4246_c = this.field_4238_k.generateNoiseOctaves(this.field_4246_c, i2, i3, i4, i5, i6, i7, d8 / 80.0D, d10 / 60.0D, d8 / 80.0D);
		this.field_4245_d = this.field_4240_i.generateNoiseOctaves(this.field_4245_d, i2, i3, i4, i5, i6, i7, d8, d10, d8);
		this.field_4244_e = this.field_4239_j.generateNoiseOctaves(this.field_4244_e, i2, i3, i4, i5, i6, i7, d8, d10, d8);
		int i12 = 0;
		int i13 = 0;
	...
	public void populate(IChunkProvider iChunkProvider1, int i2, int i3) {
		...
		for(i6 = 0; i6 < 8; ++i6) {
			...
			random10000 = this.hellRNG;
			this.worldObj.getClass();
			i8 = random10000.nextInt(128 - 8) + 4;
		...
		for(i7 = 0; i7 < i6; ++i7) {
			...
			random10000 = this.hellRNG;
			this.worldObj.getClass();
			i9 = random10000.nextInt(128 - 8) + 4;
