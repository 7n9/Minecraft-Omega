...
public class ChunkProvider implements IChunkProvider {
	...
	public ChunkProvider(World world1, IChunkLoader iChunkLoader2, IChunkProvider iChunkProvider3) {
		world1.getClass();
		this.field_28061_b = new EmptyChunk(world1, new byte[256 * 128], 0, 0);
	...
	public boolean chunkExists(int i1, int i2) {
		return this.chunkMap.func_35508_b(ChunkCoordIntPair.chunkXZ2Int(i1, i2));
	}

	public void func_35556_d(int i1, int i2) {
	...
	public boolean unload100OldestChunks() {
		...
		for(i1 = 0; i1 < 10; ++i1) {
			...
			if(entityPlayer5 == null) {
				this.func_35556_d(chunk4.xPosition, chunk4.zPosition);
			}
		}
