...
public class MapInfo {
	...
	public byte[] func_28118_a(ItemStack itemStack1) {
		...
		if(--this.field_28122_f < 0) {
			...
			byte[] b2 = new byte[this.mapDataObj.field_28157_i.size() * 3 + 1];
			b2[0] = 1;

			for(i3 = 0; i3 < this.mapDataObj.field_28157_i.size(); ++i3) {
				MapCoord mapCoord4 = (MapCoord)this.mapDataObj.field_28157_i.get(i3);
		...
		for(int i8 = 0; i8 < 10; ++i8) {
			...
			if(this.field_28119_b[i3] >= 0) {
				...
				for(int i7 = 0; i7 < b6.length - 3; ++i7) {
					b6[i7 + 3] = this.mapDataObj.field_28160_f[(i7 + i5) * 128 + i3];
				}
