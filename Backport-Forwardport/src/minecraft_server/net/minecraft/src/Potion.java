...
public class Potion {
	...
	protected Potion(int i1) {
		this.field_35447_H = i1;
		field_35455_a[i1] = this;
	}

	public void func_35438_a(EntityLiving entityLiving1, int i2) {
		if(this.field_35447_H == field_35458_l.field_35447_H) {
			...
			if(entityLiving1.health > 1) {
				entityLiving1.attackEntityFrom(DamageSource.field_35094_l, 1);
			}
		} else if(this.field_35447_H == field_35468_s.field_35447_H && entityLiving1 instanceof EntityPlayer) {
			((EntityPlayer)entityLiving1).func_35198_b(0.025F * (float)(i2 + 1));
			...
			entityLiving1.attackEntityFrom(DamageSource.field_35094_l, 4 << i2);
		}
	...
	public Potion func_35439_a(String string1) {
		this.field_35448_I = string1;
		return this;
	}
}
