	...
	public void onUpdate() {
		if(this.blockID == 0) {
			...
			if(this.onGround) {
				...
				this.motionY *= -0.5D;
				this.setEntityDead();
				if((!this.worldObj.canBlockBePlacedAt(this.blockID, i1, i2, i3, true, 1) || BlockSand.canFallBelow(this.worldObj, i1, i2 - 1, i3) || !this.worldObj.setBlockWithNotify(i1, i2, i3, this.blockID)) && !this.worldObj.singleplayerWorld) {
