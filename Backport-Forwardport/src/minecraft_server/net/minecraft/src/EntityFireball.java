...
public class EntityFireball extends Entity {
	...
	public void onUpdate() {
		...
		if(movingObjectPosition3 != null) {
			if(!this.worldObj.singleplayerWorld) {
				if(movingObjectPosition3.entityHit != null && movingObjectPosition3.entityHit.attackEntityFrom(DamageSource.func_35082_a(this, this.shootingEntity), 0)) {
					;
				}
	...
	public boolean attackEntityFrom(DamageSource damageSource1, int i2) {
		...
		if(damageSource1.func_35080_a() != null) {
			Vec3D vec3D3 = damageSource1.func_35080_a().getLookVec();
			if(vec3D3 != null) {
