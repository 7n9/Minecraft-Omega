...
public abstract class Entity {
			...
			if(this.canTriggerWalking() && !z18 && this.ridingEntity == null) {
				...
				if(this.distanceWalkedModified > (float)this.nextStepDistance && i28 > 0) {
					...
					if(this.worldObj.getBlockId(i38, i26 + 1, i39) == Block.snow.blockID) {
						...
						this.worldObj.playSoundAtEntity(this, stepSound29.stepSoundDir(), stepSound29.getVolume() * 0.15F, stepSound29.getPitch());
	...
	public void func_35146_g(boolean z1) {
		this.setFlag(3, z1);
	}

	public void func_35148_h(boolean z1) {
		this.setFlag(4, z1);
	}
