...
public class ItemBow extends Item {
	...
	public void func_35408_a(ItemStack itemStack1, World world2, EntityPlayer entityPlayer3, int i4) {
		if(entityPlayer3.inventory.func_35177_c(Item.arrow.shiftedIndex)) {
			int i5 = this.func_35404_c(itemStack1) - i4;
			...
			if(f6 == 1.0F) {
				entityArrow7.field_35160_d = true;
			}
