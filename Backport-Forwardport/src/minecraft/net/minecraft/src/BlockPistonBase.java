...
public class BlockPistonBase extends Block {
	...
	public int getBlockTextureFromSideAndMetadata(int i1, int i2) {
		...
		return i3 > 5 ? this.blockIndexInTexture : (i1 == i3 ? (!isExtended(i2) && this.minX <= 0.0D && this.minY <= 0.0D && this.minZ <= 0.0D && this.maxX >= 1.0D && this.maxY >= 1.0D && this.maxZ >= 1.0D ? this.blockIndexInTexture : 110) : (i1 == PistonBlockTextures.field_31057_a[i3] ? 109 : 108));
	}
	...
	public void playBlock(World world1, int i2, int i3, int i4, int i5, int i6) {
		...
		if(i5 == 0) {
			...
			world1.setBlockTileEntity(i2, i3, i4, BlockPistonMoving.getNewTileEntity(this.blockID, i6, i6, false, true));
			if(this.isSticky) {
				...
				if(z14 || i12 <= 0 || !canPushBlock(i12, world1, i9, i10, i11, false) || Block.blocksList[i12].getMobilityFlag() != 0 && i12 != Block.pistonBase.blockID && i12 != Block.pistonStickyBase.blockID) {
					...
					world1.setBlockTileEntity(i2, i3, i4, BlockPistonMoving.getNewTileEntity(i12, i13, i6, false, false));
				}
			} else {
				this.ignoreUpdates = false;
				world1.setBlockWithNotify(i2 + PistonBlockTextures.offsetsXForSide[i6], i3 + PistonBlockTextures.offsetsYForSide[i6], i4 + PistonBlockTextures.offsetsZForSide[i6], 0);
	...
	private boolean tryExtend(World world1, int i2, int i3, int i4, int i5) {
		...
		while(i6 != i2 || i7 != i3 || i8 != i4) {
			...
			if(i12 == this.blockID && i9 == i2 && i10 == i3 && i11 == i4) {
				...
				world1.setBlockTileEntity(i6, i7, i8, BlockPistonMoving.getNewTileEntity(Block.pistonExtension.blockID, i5 | (this.isSticky ? 8 : 0), i5, true, false));
			} else {
				world1.setBlockAndMetadata(i6, i7, i8, Block.pistonMoving.blockID, i13);
				world1.setBlockTileEntity(i6, i7, i8, BlockPistonMoving.getNewTileEntity(i12, i13, i5, true, false));
			}
