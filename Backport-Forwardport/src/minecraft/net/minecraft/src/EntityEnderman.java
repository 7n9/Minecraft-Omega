...
public class EntityEnderman extends EntityMob {
	...
	public void writeEntityToNBT(NBTTagCompound nBTTagCompound1) {
		...
		nBTTagCompound1.setShort("carried", (short)this.func_35176_r());
		nBTTagCompound1.setShort("carriedData", (short)this.func_35180_s());
	}

	public void readEntityFromNBT(NBTTagCompound nBTTagCompound1) {
		super.readEntityFromNBT(nBTTagCompound1);
		this.func_35177_b(nBTTagCompound1.getShort("carried"));
		this.func_35181_c(nBTTagCompound1.getShort("carryingData"));
	}

	protected Entity findPlayerToAttack() {
		EntityPlayer entityPlayer1 = this.worldObj.getClosestPlayerToEntity(this, 64.0D);
		if(entityPlayer1 != null) {
			if(this.func_35183_c(entityPlayer1)) {
	...
	private boolean func_35183_c(EntityPlayer entityPlayer1) {
		...
		if(itemStack2 != null && itemStack2.itemID == Block.pumpkin.blockID) {
			...
			double d7 = vec3D3.func_35612_b(vec3D4);
		...
		if(!this.worldObj.multiplayerWorld) {
			...
			if(this.func_35176_r() == 0) {
				if(this.rand.nextInt(20) == 0) {
					...
					if(field_35186_b[i4]) {
						this.func_35177_b(this.worldObj.getBlockId(i1, i2, i3));
						this.func_35181_c(this.worldObj.getBlockMetadata(i1, i2, i3));
				...
				if(i4 == 0 && i5 > 0 && Block.blocksList[i5].renderAsNormalBlock()) {
					this.worldObj.setBlockAndMetadataWithNotify(i1, i2, i3, this.func_35176_r(), this.func_35180_s());
					this.func_35177_b(0);
				}
			}
		}
	...
	protected boolean func_35178_q() {
		...
		return this.func_35179_a_(d1, d3, d5);
	}

	protected boolean func_35182_c(Entity entity1) {
		...
		return this.func_35179_a_(d5, d7, d9);
	}

	protected boolean func_35179_a_(double d1, double d3, double d5) {
		double d7 = this.posX;
		double d9 = this.posY;
	...
	public void func_35177_b(int i1) {
	...
	public void func_35181_c(int i1) {
