...
public class EntitySilverfish extends EntityMob {
	...
	public boolean attackEntityFrom(DamageSource damageSource1, int i2) {
		if(this.field_35189_a <= 0 && damageSource1 instanceof EntityDamageSource) {
	...
	protected void attackEntity(Entity entity1, float f2) {
		if(this.attackTime <= 0 && f2 < 1.2F && entity1.boundingBox.maxY > this.boundingBox.minY && entity1.boundingBox.minY < this.boundingBox.maxY) {
			this.attackTime = 20;
			entity1.attackEntityFrom(DamageSource.func_35525_a(this), this.attackStrength);
		}
	...
	protected void updateEntityActionState() {
		...
		if(!this.worldObj.multiplayerWorld) {
					...
					for(i5 = 0; !z4 && i5 <= 5 && i5 >= -5; i5 = i5 <= 0 ? 1 - i5 : 0 - i5) {
						for(int i6 = 0; !z4 && i6 <= 10 && i6 >= -10; i6 = i6 <= 0 ? 1 - i6 : 0 - i6) {
							for(int i7 = 0; !z4 && i7 <= 10 && i7 >= -10; i7 = i7 <= 0 ? 1 - i7 : 0 - i7) {
								...
								if(i8 == Block.field_35289_bm.blockID) {
									this.worldObj.playAuxSFX(2001, i1 + i6, i2 + i5, i3 + i7, Block.field_35289_bm.blockID + this.worldObj.getBlockMetadata(i1 + i6, i2 + i5, i3 + i7) * 256);
									this.worldObj.setBlockWithNotify(i1 + i6, i2 + i5, i3 + i7, 0);
									Block.field_35289_bm.onBlockDestroyedByPlayer(this.worldObj, i1 + i6, i2 + i5, i3 + i7, 0);
			...
			if(this.entityToAttack == null && !this.hasPath()) {
				...
				if(BlockSilverfish.func_35305_d(i5)) {
					this.worldObj.setBlockAndMetadataWithNotify(i1 + PistonBlockTextures.offsetsXForSide[i9], i2 + PistonBlockTextures.offsetsYForSide[i9], i3 + PistonBlockTextures.offsetsZForSide[i9], Block.field_35289_bm.blockID, BlockSilverfish.func_35304_f(i5));
