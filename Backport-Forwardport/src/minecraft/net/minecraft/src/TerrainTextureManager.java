...
public class TerrainTextureManager {
	...
	public void func_799_a(IsoImageBuffer isoImageBuffer1) {
		...
		if(world2 == null) {
			...
			int i3 = isoImageBuffer1.chunkX * 16;
			int i4 = isoImageBuffer1.chunkZ * 16;
			int i5 = i3 + 16;
			int i6 = i4 + 16;
			Chunk chunk7 = world2.getChunkFromChunkCoords(isoImageBuffer1.chunkX, isoImageBuffer1.chunkZ);
			if(chunk7.func_21167_h()) {
							...
							if(i15 < this.field_1183_f[i12] || i15 < this.field_1183_f[i12 + 1]) {
								...
								if(block16 == null) {
									...
									if(block16.blockMaterial == Material.water) {
										...
										f10000 = (float)i14;
										world2.getClass();
										float f17 = f10000 / (128.0F - 1.0F) * 0.6F + 0.4F;
										int i18;
										int i19;
										float f20;
										float f22;
				...
				if(isoImageBuffer1.field_1348_a == null) {
					isoImageBuffer1.field_1348_a = new BufferedImage(32, 544, 2);
				}

				isoImageBuffer1.field_1348_a.setRGB(0, 0, 32, 544, this.field_1180_b, 0, 32);
				isoImageBuffer1.field_1352_e = true;
			}
		}
	}
