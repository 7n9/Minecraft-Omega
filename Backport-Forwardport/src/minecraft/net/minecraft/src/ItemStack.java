...
public final class ItemStack {
	...
	public static ItemStack func_35864_a(NBTTagCompound nBTTagCompound0) {
	...
	public ItemStack func_35863_b(World world1, EntityPlayer entityPlayer2) {
		return this.getItem().func_35413_b(this, world1, entityPlayer2);
	}
	...
	public void func_35862_a(World world1, EntityPlayer entityPlayer2, int i3) {
		this.getItem().func_35414_a(this, world1, entityPlayer2, i3);
	}
}
