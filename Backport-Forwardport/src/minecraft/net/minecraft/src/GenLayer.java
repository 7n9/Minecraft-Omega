...
public abstract class GenLayer {
	...
	public static GenLayer[] func_35497_a(long j0) {
		...
		genLayerIsland10 = new GenLayerIsland(3L, genLayerZoom11);
		byte b3 = 4;
		GenLayer genLayer4 = GenLayerZoom.func_35515_a(1000L, genLayerIsland10, 0);
		GenLayerRiverInit genLayerRiverInit12 = new GenLayerRiverInit(100L, genLayer4);
		genLayer4 = GenLayerZoom.func_35515_a(1000L, genLayerRiverInit12, b3 + 2);
		...
		GenLayer genLayer5 = GenLayerZoom.func_35515_a(1000L, genLayerIsland10, 0);
		GenLayerVillageLandscape genLayerVillageLandscape15 = new GenLayerVillageLandscape(200L, genLayer5);
		Object object16 = GenLayerZoom.func_35515_a(1000L, genLayerVillageLandscape15, 2);
		...
		GenLayer genLayer19 = GenLayerSmoothZoom.func_35517_a(1000L, (GenLayer)object6, 2);
		GenLayer genLayer22 = GenLayerSmoothZoom.func_35517_a(1000L, (GenLayer)object7, 2);
		GenLayerZoomVoronoi genLayerZoomVoronoi23 = new GenLayerZoomVoronoi(10L, genLayerRiverMix20);
		genLayerRiverMix20.func_35496_b(j0);
		genLayer19.func_35496_b(j0);
		genLayer22.func_35496_b(j0);
		genLayerZoomVoronoi23.func_35496_b(j0);
		return new GenLayer[]{genLayerRiverMix20, genLayerZoomVoronoi23, genLayer19, genLayer22};
	}

	public GenLayer(long j1) {
		this.field_35501_d = j1;
	...
	public void func_35496_b(long j1) {
		this.field_35502_b = j1;
		if(this.field_35504_a != null) {
			this.field_35504_a.func_35496_b(j1);
		}
	...
	protected int func_35498_a(int i1) {
		int i2 = (int)((this.field_35503_c >> 24) % (long)i1);
		if(i2 < 0) {
			i2 += i1;
		}
	...
	public abstract int[] func_35500_a(int i1, int i2, int i3, int i4);
}
