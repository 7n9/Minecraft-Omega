...
public class WorldGenSwamp extends WorldGenerator {
								...
								for(i13 = i5 - i11; i13 <= i5 + i11; ++i13) {
									if(world1.getBlockId(i12, i16, i13) == Block.leaves.blockID) {
										if(random2.nextInt(4) == 0 && world1.getBlockId(i12 - 1, i16, i13) == 0) {
											this.func_35265_a(world1, i12 - 1, i16, i13, 8);
										}

										if(random2.nextInt(4) == 0 && world1.getBlockId(i12 + 1, i16, i13) == 0) {
											this.func_35265_a(world1, i12 + 1, i16, i13, 2);
										}

										if(random2.nextInt(4) == 0 && world1.getBlockId(i12, i16, i13 - 1) == 0) {
											this.func_35265_a(world1, i12, i16, i13 - 1, 1);
										}

										if(random2.nextInt(4) == 0 && world1.getBlockId(i12, i16, i13 + 1) == 0) {
											this.func_35265_a(world1, i12, i16, i13 + 1, 4);
										}
									}
								}
							}
	...
	private void func_35265_a(World world1, int i2, int i3, int i4, int i5) {
		world1.setBlockAndMetadataWithNotify(i2, i3, i4, Block.field_35278_bv.blockID, i5);
		int i6 = 4;
