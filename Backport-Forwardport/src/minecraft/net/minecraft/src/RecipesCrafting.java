...
public class RecipesCrafting {
	public void addRecipes(CraftingManager craftingManager1) {
		...
		craftingManager1.addRecipe(new ItemStack(Block.field_35285_bn, 4), new Object[]{"##", "##", '#', Block.stone});
		craftingManager1.addRecipe(new ItemStack(Block.field_35288_bq, 16), new Object[]{"###", "###", '#', Item.ingotIron});
		craftingManager1.addRecipe(new ItemStack(Block.field_35282_br, 16), new Object[]{"###", "###", '#', Block.glass});
	}
}
