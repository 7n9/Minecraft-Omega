		...
		if(!entityPlayer2.func_35190_e(i4, i5, i6)) {
			...
			if(itemStack1.getItemDamage() == 15) {
				...
				if(i8 == Block.mushroomBrown.blockID || i8 == Block.mushroomRed.blockID) {
					if(!world3.multiplayerWorld && ((BlockMushroom)Block.blocksList[i8]).func_35293_c(world3, i4, i5, i6, world3.rand)) {
						--itemStack1.stackSize;
					}
				...
				if(i8 == Block.field_35283_bu.blockID || i8 == Block.field_35284_bt.blockID) {
					if(!world3.multiplayerWorld) {
						((BlockStem)Block.blocksList[i8]).func_35294_i(world3, i4, i5, i6);
						--itemStack1.stackSize;
					}
