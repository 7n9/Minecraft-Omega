...
public class EntityWolf extends EntityAnimal {
			...
			if(!this.isWolfTamed() && !this.isWolfAngry()) {
				...
				if(entity3 instanceof EntityLiving) {
					...
					while(iterator5.hasNext()) {
						...
						if(!entityWolf7.isWolfTamed() && entityWolf7.entityToAttack == null) {
							entityWolf7.entityToAttack = entity3;
							if(entity3 instanceof EntityPlayer) {
								entityWolf7.setWolfAngry(true);
							}
						}
					}
				}
			} else if(entity3 != this && entity3 != null) {
				if(this.isWolfTamed() && entity3 instanceof EntityPlayer && ((EntityPlayer)entity3).username.equalsIgnoreCase(this.getWolfOwner())) {
					return true;
				}
	...
	protected void attackEntity(Entity entity1, float f2) {
		if(f2 > 2.0F && f2 < 6.0F && this.rand.nextInt(10) == 0) {
			...
			entity1.attackEntityFrom(DamageSource.func_35525_a(this), b3);
		}
