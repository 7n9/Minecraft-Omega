...
public class ItemDoor extends Item {
	...
	public boolean onItemUse(ItemStack itemStack1, EntityPlayer entityPlayer2, World world3, int i4, int i5, int i6, int i7) {
		if(i7 != 1) {
			...
			if(entityPlayer2.func_35190_e(i4, i5, i6) && entityPlayer2.func_35190_e(i4, i5 + 1, i6)) {
				if(!block8.canPlaceBlockAt(world3, i4, i5, i6)) {
					...
					func_35434_a(world3, i4, i5, i6, i9, block8);
	...
	public static void func_35434_a(World world0, int i1, int i2, int i3, int i4, Block block5) {
		byte b6 = 0;
		byte b7 = 0;
		if(i4 == 0) {
			b7 = 1;
