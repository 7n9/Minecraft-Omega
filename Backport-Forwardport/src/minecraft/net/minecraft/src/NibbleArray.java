...
public class NibbleArray {
	...
	public NibbleArray(int i1, int i2) {
		...
		this.field_35754_b = i2;
		this.field_35755_c = i2 + 4;
	}
	...
	public int getNibble(int i1, int i2, int i3) {
		int i4 = i1 << this.field_35755_c | i3 << this.field_35754_b | i2;
		int i5 = i4 >> 1;
		int i6 = i4 & 1;
	...
	public void setNibble(int i1, int i2, int i3, int i4) {
		int i5 = i1 << this.field_35755_c | i3 << this.field_35754_b | i2;
		int i6 = i5 >> 1;
		int i7 = i5 & 1;
		if(i7 == 0) {
