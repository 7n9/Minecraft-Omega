...
public class DamageSource {
	...
	public static DamageSource func_35525_a(EntityLiving entityLiving0) {
		return new EntityDamageSource("mob", entityLiving0);
	}

	public static DamageSource func_35527_a(EntityPlayer entityPlayer0) {
		return new EntityDamageSource("player", entityPlayer0);
	}

	public static DamageSource func_35535_a(EntityArrow entityArrow0, Entity entity1) {
		return new EntityDamageSourceIndirect("arrow", entityArrow0, entity1);
	}

	public static DamageSource func_35530_a(EntityFireball entityFireball0, Entity entity1) {
		return new EntityDamageSourceIndirect("fireball", entityFireball0, entity1);
	}

	public static DamageSource func_35524_a(Entity entity0, Entity entity1) {
