...
public class EntityEgg extends Entity {
	...
	public void onUpdate() {
		...
		if(movingObjectPosition3 != null) {
			if(movingObjectPosition3.entityHit != null && movingObjectPosition3.entityHit.attackEntityFrom(DamageSource.func_35524_a(this, this.field_20051_g), 0)) {
				;
			}
	...
	public void onCollideWithPlayer(EntityPlayer entityPlayer1) {
		if(this.inGround && this.field_20051_g == entityPlayer1 && this.shake <= 0 && entityPlayer1.inventory.addItemStackToInventory(new ItemStack(Item.arrow, 1))) {
