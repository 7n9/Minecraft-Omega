...
public class MapGenRavine extends MapGenBase {
	...
	protected void func_35626_a(long j1, int i3, int i4, byte[] b5, double d6, double d8, double d10, float f12, float f13, float f14, int i15, int i16, double d17) {
	...
	protected void recursiveGenerate(World world1, int i2, int i3, int i4, int i5, byte[] b6) {
		if(this.rand.nextInt(50) == 0) {
			...
			for(int i14 = 0; i14 < b13; ++i14) {
				...
				this.func_35626_a(this.rand.nextLong(), i4, i5, b6, d7, d9, d11, f17, f15, f16, 0, 0, 3.0D);
			}
