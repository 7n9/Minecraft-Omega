...
public class RenderGlobal implements IWorldAccess {
	...
	public void renderEntities(Vec3D vec3D1, ICamera iCamera2, float f3) {
		if(this.renderEntitiesStartupCounter > 0) {
			...
			this.mc.entityRenderer.func_35806_b((double)f3);
			...
			this.mc.entityRenderer.func_35810_a((double)f3);
		}
	}
	...
	public void renderSky(float f1) {
		if(!this.mc.theWorld.worldProvider.isNether) {
			...
			RenderHelper.disableStandardItemLighting();
			float[] f17 = this.worldObj.worldProvider.calcSunriseSunsetColors(this.worldObj.getCelestialAngle(f1), f1);
			float f9;
			float f10;
			float f11;
			float f12;
			if(f17 != null) {
				...
				GL11.glRotatef(MathHelper.sin(this.worldObj.func_35456_d(f1)) < 0.0F ? 180.0F : 0.0F, 0.0F, 0.0F, 1.0F);
				f8 = f17[0];
				f9 = f17[1];
				f10 = f17[2];
				float f13;
				...
				tessellator16.startDrawing(6);
				tessellator16.setColorRGBA_F(f8, f9, f10, f17[3]);
				tessellator16.addVertex(0.0D, 100.0D, 0.0D);
				byte b19 = 16;
				tessellator16.setColorRGBA_F(f17[0], f17[1], f17[2], 0.0F);

				for(int i20 = 0; i20 <= b19; ++i20) {
					f13 = (float)i20 * (float)Math.PI * 2.0F / (float)b19;
					float f14 = MathHelper.sin(f13);
					float f15 = MathHelper.cos(f13);
					tessellator16.addVertex((double)(f14 * 120.0F), (double)(f15 * 120.0F), (double)(-f15 * 40.0F * f17[3]));
				}
			...
			tessellator16.addVertexWithUV((double)(-f11), 100.0D, (double)(-f11), 0.0D, 0.0D);
			tessellator16.addVertexWithUV((double)f11, 100.0D, (double)(-f11), 1.0D, 0.0D);
			tessellator16.addVertexWithUV((double)f11, 100.0D, (double)f11, 1.0D, 1.0D);
			tessellator16.addVertexWithUV((double)(-f11), 100.0D, (double)f11, 0.0D, 1.0D);
			tessellator16.draw();
			f11 = 20.0F;
			...
			double d18 = this.mc.thePlayer.getPosition(f1).yCoord - 64.0D;
			if(d18 < 0.0D) {
				GL11.glPushMatrix();
				...
				tessellator16.addVertex((double)(-f9), (double)f10, (double)f9);
				tessellator16.addVertex((double)f9, (double)f10, (double)f9);
				tessellator16.addVertex((double)f9, (double)f11, (double)f9);
				tessellator16.addVertex((double)(-f9), (double)f11, (double)f9);
				tessellator16.addVertex((double)(-f9), (double)f11, (double)(-f9));
				tessellator16.addVertex((double)f9, (double)f11, (double)(-f9));
				tessellator16.addVertex((double)f9, (double)f10, (double)(-f9));
			...
			GL11.glPushMatrix();
			GL11.glTranslatef(0.0F, -((float)(d18 - 16.0D)), 0.0F);
			GL11.glCallList(this.glSkyList2);
			GL11.glPopMatrix();
			GL11.glEnable(GL11.GL_TEXTURE_2D);
			GL11.glDepthMask(true);
	...
	public void renderClouds(float f1) {
		if(!this.mc.theWorld.worldProvider.isNether) {
			if(this.mc.gameSettings.fancyGraphics) {
				...
				f10 = 4.8828125E-4F;
				double d24 = (double)((float)this.cloudOffsetX + f1) + (this.worldObj.field_35467_J + (this.worldObj.field_35468_K - this.worldObj.field_35467_J) * (double)f1) * 24000.0D;
	...
	public void renderCloudsFancy(float f1) {
		...
		float f4 = 12.0F;
		float f5 = 4.0F;
		double d6 = (double)((float)this.cloudOffsetX + f1) + (this.worldObj.field_35467_J + (this.worldObj.field_35468_K - this.worldObj.field_35467_J) * (double)f1) * 24000.0D;
	...
	public void spawnParticle(String string1, double d2, double d4, double d6, double d8, double d10, double d12) {
		if(this.mc != null && this.mc.renderViewEntity != null && this.mc.effectRenderer != null) {
			...
			if(string1.equals("hugeexplosion")) {
				this.mc.effectRenderer.addEffect(new EntityHugeExplodeFX(this.worldObj, d2, d4, d6, d8, d10, d12));
			}

			if(string1.equals("largeexplode")) {
				this.mc.effectRenderer.addEffect(new EntityLargeExplodeFX(this.renderEngine, this.worldObj, d2, d4, d6, d8, d10, d12));
			}
			...
			if(d14 * d14 + d16 * d16 + d18 * d18 <= d20 * d20) {
				if(string1.equals("bubble")) {
					...
					this.mc.effectRenderer.addEffect(new EntitySuspendFX(this.worldObj, d2, d4, d6, d8, d10, d12));
				} else if(string1.equals("depthsuspend")) {
					this.mc.effectRenderer.addEffect(new EntityAuraFX(this.worldObj, d2, d4, d6, d8, d10, d12));
				} else if(string1.equals("townaura")) {
					this.mc.effectRenderer.addEffect(new EntityAuraFX(this.worldObj, d2, d4, d6, d8, d10, d12));
				} else if(string1.equals("crit")) {
					this.mc.effectRenderer.addEffect(new EntityCritFX(this.worldObj, d2, d4, d6, d8, d10, d12));
					...
					this.mc.effectRenderer.addEffect(new EntityCloudFX(this.worldObj, d2, d4, d6, d8, d10, d12));
					...
					if(string1.startsWith("iconcrack_")) {
						i22 = Integer.parseInt(string1.substring(string1.indexOf("_") + 1));
						this.mc.effectRenderer.addEffect(new EntitySlimeFX(this.worldObj, d2, d4, d6, d8, d10, d12, Item.itemsList[i22]));
					} else if(string1.startsWith("tilecrack_")) {
						i22 = Integer.parseInt(string1.substring(string1.indexOf("_") + 1));
						this.mc.effectRenderer.addEffect(new EntityDiggingFX(this.worldObj, d2, d4, d6, d8, d10, d12, Block.blocksList[i22], 0, 0));
					}
				}
