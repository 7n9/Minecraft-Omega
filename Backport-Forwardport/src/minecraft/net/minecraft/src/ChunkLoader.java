...
public class ChunkLoader implements IChunkLoader {
	...
	public Chunk loadChunk(World world1, int i2, int i3) throws IOException {
		...
		if(file4 != null && file4.exists()) {
			try {
				...
				NBTTagCompound nBTTagCompound6 = CompressedStreamTools.loadGzippedCompoundFromOutputStream(fileInputStream5);
	...
	public static Chunk loadChunkIntoWorldFromCompound(World world0, NBTTagCompound nBTTagCompound1) {
		...
		byte[] b10003 = nBTTagCompound1.getByteArray("Data");
		world0.getClass();
		chunk4.data = new NibbleArray(b10003, 7);
		b10003 = nBTTagCompound1.getByteArray("SkyLight");
		world0.getClass();
		chunk4.skylightMap = new NibbleArray(b10003, 7);
		b10003 = nBTTagCompound1.getByteArray("BlockLight");
		world0.getClass();
		chunk4.blocklightMap = new NibbleArray(b10003, 7);
		...
		if(!chunk4.data.isValid()) {
			i13 = chunk4.blocks.length;
			world0.getClass();
			chunk4.data = new NibbleArray(i13, 7);
		}
		...
		if(chunk4.heightMap == null || !chunk4.skylightMap.isValid()) {
			...
			i13 = chunk4.blocks.length;
			world0.getClass();
			chunk4.skylightMap = new NibbleArray(i13, 7);
		...
		if(!chunk4.blocklightMap.isValid()) {
			i13 = chunk4.blocks.length;
			world0.getClass();
			chunk4.blocklightMap = new NibbleArray(i13, 7);
			chunk4.func_1014_a();
		}
