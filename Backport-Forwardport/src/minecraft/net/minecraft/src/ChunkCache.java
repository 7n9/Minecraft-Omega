...
public class ChunkCache implements IBlockAccess {
	...
	public int func_35451_b(int i1, int i2, int i3, int i4) {
		int i5 = this.func_35454_a(EnumSkyBlock.Sky, i1, i2, i3);
		int i6 = this.func_35454_a(EnumSkyBlock.Block, i1, i2, i3);
		if(i6 < i4) {
			i6 = i4;
		}
	...
	public int func_35454_a(EnumSkyBlock enumSkyBlock1, int i2, int i3, int i4) {
		if(i3 < 0) {
			i3 = 0;
		}
		...
		if(i3 >= 0) {
			this.worldObj.getClass();
			if(i3 < 128 && i2 >= -30000000 && i4 >= -30000000 && i2 < 30000000 && i4 <= 30000000) {
				int i5 = this.getBlockId(i2, i3, i4);
				int i6;
				...
				i6 = this.func_35453_b(enumSkyBlock1, i2, i3 + 1, i4);
				int i7 = this.func_35453_b(enumSkyBlock1, i2 + 1, i3, i4);
				int i8 = this.func_35453_b(enumSkyBlock1, i2 - 1, i3, i4);
				int i9 = this.func_35453_b(enumSkyBlock1, i2, i3, i4 + 1);
				int i10 = this.func_35453_b(enumSkyBlock1, i2, i3, i4 - 1);
				if(i7 > i6) {
					i6 = i7;
				}
	...
	public int func_35453_b(EnumSkyBlock enumSkyBlock1, int i2, int i3, int i4) {
		if(i3 < 0) {
			i3 = 0;
		}
