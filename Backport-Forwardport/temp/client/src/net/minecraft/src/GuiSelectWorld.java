...
public class GuiSelectWorld extends GuiScreen {
	...
	public void initGui() {
		...
		this.field_35316_k[0] = stringTranslate1.translateKey("gameMode.survival");
		this.field_35316_k[1] = stringTranslate1.translateKey("gameMode.creative");
		this.loadSaves();
	...
	public void selectWorld(int i1) {
		...
		if(!this.selected) {
			this.selected = true;
			int i2 = ((SaveFormatComparator)this.saveList.get(i1)).func_35719_f();
			if(i2 == 0) {
	...
	static String[] func_35315_i(GuiSelectWorld guiSelectWorld0) {
		return guiSelectWorld0.field_35316_k;
	}
}
