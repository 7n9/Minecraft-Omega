...
public class EntitySkeleton extends EntityMob {
	...
	public void onDeath(DamageSource damageSource1) {
		...
		if(damageSource1.func_35526_e() instanceof EntityArrow && damageSource1.func_35532_a() instanceof EntityPlayer) {
			EntityPlayer entityPlayer2 = (EntityPlayer)damageSource1.func_35532_a();
			double d3 = entityPlayer2.posX - this.posX;
			double d5 = entityPlayer2.posZ - this.posZ;
			if(d3 * d3 + d5 * d5 >= 2500.0D) {
				entityPlayer2.triggerAchievement(AchievementList.field_35608_v);
			}
		}
