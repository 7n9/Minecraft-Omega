...
public class TileEntityRenderer {
	...
	public void renderTileEntity(TileEntity tileEntity1, float f2) {
		if(tileEntity1.getDistanceFrom(this.playerX, this.playerY, this.playerZ) < 4096.0D) {
			int i3 = this.worldObj.func_35451_b(tileEntity1.xCoord, tileEntity1.yCoord, tileEntity1.zCoord, 0);
			int i4 = i3 % 65536;
			int i5 = i3 / 65536;
			GL13.glMultiTexCoord2f(ARBMultitexture.GL_TEXTURE1_ARB, (float)i4 / 1.0F, (float)i5 / 1.0F);
