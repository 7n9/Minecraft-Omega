...
public class GuiMainMenu extends GuiScreen {
	...
	private void func_35355_b(int i1, int i2, float f3) {
		...
		for(int i6 = 0; i6 < b5 * b5; ++i6) {
			...
			GL11.glRotatef(MathHelper.sin(((float)this.field_35357_f + f3) / 400.0F) * 25.0F + 20.0F, 1.0F, 0.0F, 0.0F);
			GL11.glRotatef(-((float)this.field_35357_f + f3) * 0.1F, 0.0F, 1.0F, 0.0F);
		...
		tessellator4.setTranslationD(0.0D, 0.0D, 0.0D);
	...
	private void func_35354_a(float f1) {
	...
	private void func_35356_c(int i1, int i2, float f3) {
		GL11.glViewport(0, 0, 256, 256);
		this.func_35355_b(i1, i2, f3);
		this.func_35354_a(f3);
		this.func_35354_a(f3);
		this.func_35354_a(f3);
		this.func_35354_a(f3);
		this.func_35354_a(f3);
	...
	public void drawScreen(int i1, int i2, float f3) {
		this.func_35356_c(i1, i2, f3);
		Tessellator tessellator4 = Tessellator.instance;
		short s5 = 274;
		int i6 = this.width / 2 - s5 / 2;
		byte b7 = 30;
		this.drawGradientRect(0, 0, this.width, this.height, -1426063361, 0xFFFFFF);
		...
		GL11.glPopMatrix();
		this.drawString(this.fontRenderer, "Minecraft Beta 1.8", 2, this.height - 10, 0xFFFFFF);
