...
public abstract class Entity {
			...
			if(this.canTriggerWalking() && !z18 && this.ridingEntity == null) {
				...
				if(this.distanceWalkedModified > (float)this.nextStepDistance && i28 > 0) {
					...
					if(this.worldObj.getBlockId(i38, i26 + 1, i39) == Block.snow.blockID) {
						...
						this.worldObj.playSoundAtEntity(this, stepSound29.stepSoundDir2(), stepSound29.getVolume() * 0.15F, stepSound29.getPitch());
	...
	public int func_35115_a(float f1) {
		...
		if(world10000.blockExists(i2, 128 / 2, i3)) {
			...
			return this.worldObj.func_35451_b(i2, i6, i3, 0);
		} else {
			return 0;
		}
	}
	...
	public void func_35116_d(boolean z1) {
		this.setFlag(4, z1);
	}
