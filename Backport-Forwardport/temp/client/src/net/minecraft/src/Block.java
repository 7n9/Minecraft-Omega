...
public class Block {
	...
	public int func_35275_c(IBlockAccess iBlockAccess1, int i2, int i3, int i4) {
		return iBlockAccess1.func_35451_b(i2, i3, i4, lightValue[this.blockID]);
	}
	...
	public void harvestBlock(World world1, EntityPlayer entityPlayer2, int i3, int i4, int i5, int i6) {
		...
		entityPlayer2.func_35198_d(0.025F);
	...
	public float func_35276_e(IBlockAccess iBlockAccess1, int i2, int i3, int i4) {
