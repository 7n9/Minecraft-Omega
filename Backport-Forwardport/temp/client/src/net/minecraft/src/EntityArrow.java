		...
		if(this.inGround) {
			...
			if(movingObjectPosition3 != null) {
				if(movingObjectPosition3.entityHit != null) {
					...
					if(movingObjectPosition3.entityHit.attackEntityFrom(DamageSource.func_35535_a(this, this.shootingEntity), i20)) {
						if(movingObjectPosition3.entityHit instanceof EntityLiving) {
							++((EntityLiving)movingObjectPosition3.entityHit).field_35172_bP;
						}
