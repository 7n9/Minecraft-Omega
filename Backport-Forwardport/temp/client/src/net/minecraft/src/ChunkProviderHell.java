...
public class ChunkProviderHell implements IChunkProvider {
	...
	public void func_4059_a(int i1, int i2, byte[] b3) {
		...
		int i7 = 128 / 8 + 1;
		int i8 = b4 + 1;
		this.field_4163_o = this.func_4057_a(this.field_4163_o, i1 * b4, 0, i2 * b4, i6, i7, i8);
		...
		for(int i9 = 0; i9 < b4; ++i9) {
			for(int i10 = 0; i10 < b4; ++i10) {
				...
				while(true) {
					...
					double d12 = 0.125D;
					double d14 = this.field_4163_o[((i9 + 0) * i8 + i10 + 0) * i7 + i11 + 0];
					double d16 = this.field_4163_o[((i9 + 0) * i8 + i10 + 1) * i7 + i11 + 0];
					double d18 = this.field_4163_o[((i9 + 1) * i8 + i10 + 0) * i7 + i11 + 0];
					double d20 = this.field_4163_o[((i9 + 1) * i8 + i10 + 1) * i7 + i11 + 0];
					double d22 = (this.field_4163_o[((i9 + 0) * i8 + i10 + 0) * i7 + i11 + 1] - d14) * d12;
					double d24 = (this.field_4163_o[((i9 + 0) * i8 + i10 + 1) * i7 + i11 + 1] - d16) * d12;
					double d26 = (this.field_4163_o[((i9 + 1) * i8 + i10 + 0) * i7 + i11 + 1] - d18) * d12;
					double d28 = (this.field_4163_o[((i9 + 1) * i8 + i10 + 1) * i7 + i11 + 1] - d20) * d12;
	...
	public void func_4058_b(int i1, int i2, byte[] b3) {
		...
		int i4 = 128 - 64;
		double d5 = 8.0D / 256D;
		this.field_4162_p = this.field_4166_l.generateNoiseOctaves(this.field_4162_p, i1 * 16, i2 * 16, 0, 16, 16, 1, d5, d5, 1.0D);
		this.gravelNoise = this.field_4166_l.generateNoiseOctaves(this.gravelNoise, i1 * 16, 109, i2 * 16, 16, 1, 16, d5, 1.0D, d5);
		this.field_4160_r = this.field_4165_m.generateNoiseOctaves(this.field_4160_r, i1 * 16, i2 * 16, 0, 16, 16, 1, d5 * 2.0D, d5 * 2.0D, d5 * 2.0D);
	...
	public Chunk provideChunk(int i1, int i2) {
		...
		this.field_4159_s.generate(this, this.worldObj, i1, i2, b3);
