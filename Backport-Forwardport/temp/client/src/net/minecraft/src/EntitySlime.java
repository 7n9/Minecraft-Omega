...
public class EntitySlime extends EntityLiving implements IMob {
	...
	public void onCollideWithPlayer(EntityPlayer entityPlayer1) {
		int i2 = this.getSlimeSize();
		if(i2 > 1 && this.canEntityBeSeen(entityPlayer1) && (double)this.getDistanceToEntity(entityPlayer1) < 0.6D * (double)i2 && entityPlayer1.attackEntityFrom(DamageSource.func_35525_a(this), i2)) {
