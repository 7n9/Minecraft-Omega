...
public class MapGenStronghold extends MapGenStructure {
	...
	protected boolean func_35628_a(int i1, int i2) {
		...
		if(!this.field_35632_f) {
			...
			for(i5 = 0; i5 < this.field_35633_g.length; ++i5) {
				...
				BiomeGenBase[] biomeGenBase11 = this.field_35634_a;
				...
				ChunkPosition chunkPosition17 = this.field_35625_d.getWorldChunkManager().func_35556_a((i8 << 4) + 8, (i9 << 4) + 8, 112, arrayList10, this.rand);
				...
				this.field_35633_g[i5] = new ChunkCoordIntPair(i8, i9);
				d3 += Math.PI * 2D / (double)this.field_35633_g.length;
			}

			this.field_35632_f = true;
		}

		ChunkCoordIntPair[] chunkCoordIntPair15 = this.field_35633_g;
	...
	protected StructureStart func_35630_b(int i1, int i2) {
		return new StructureStrongholdStart(this.field_35625_d, this.rand, i1, i2);
	}
}
