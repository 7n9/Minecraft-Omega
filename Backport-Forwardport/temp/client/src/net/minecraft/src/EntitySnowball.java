...
public class EntitySnowball extends Entity {
	...
	public void onUpdate() {
		...
		if(!this.worldObj.multiplayerWorld) {
			...
			for(int i8 = 0; i8 < list5.size(); ++i8) {
				...
				if(entity9.canBeCollidedWith() && (entity9 != this.shootingEntity || this.ticksInAirSnowball >= 5)) {
					float f10 = 0.3F;
		...
		if(movingObjectPosition3 != null) {
			if(movingObjectPosition3.entityHit != null && movingObjectPosition3.entityHit.attackEntityFrom(DamageSource.func_35524_a(this, this.shootingEntity), 0)) {
				;
			}
	...
	public void onCollideWithPlayer(EntityPlayer entityPlayer1) {
		if(this.inGroundSnowball && this.shootingEntity == entityPlayer1 && this.shakeSnowball <= 0 && entityPlayer1.inventory.addItemStackToInventory(new ItemStack(Item.arrow, 1))) {
