...
public class MapStorage {
	...
	public MapDataBase loadData(Class class1, String string2) {
		...
		if(mapDataBase3 != null) {
			...
			if(this.saveHandler != null) {
				try {
					File file4 = this.saveHandler.func_28113_a(string2);
	...
	private void saveData(MapDataBase mapDataBase1) {
		if(this.saveHandler != null) {
			try {
				File file2 = this.saveHandler.func_28113_a(mapDataBase1.field_28168_a);
				if(file2 != null) {
	...
	private void loadIdCounts() {
		try {
			...
			File file1 = this.saveHandler.func_28113_a("idcounts");
	...
	public int getUniqueDataId(String string1) {
		...
		if(this.saveHandler == null) {
			...
			try {
				File file3 = this.saveHandler.func_28113_a("idcounts");
				if(file3 != null) {
					NBTTagCompound nBTTagCompound4 = new NBTTagCompound();
