...
public class RenderItem extends Render {
	...
	public void doRenderItem(EntityItem entityItem1, double d2, double d4, double d6, float f8, float f9) {
		...
		if(itemStack10.itemID < 256 && RenderBlocks.renderItemIn3d(Block.blocksList[itemStack10.itemID].getRenderType())) {
			...
			float f28 = 0.25F;
			int i29 = Block.blocksList[itemStack10.itemID].getRenderType();
			if(i29 == 1 || i29 == 19 || i29 == 12 || i29 == 2) {
				f28 = 0.5F;
			}
			...
			for(int i30 = 0; i30 < b13; ++i30) {
				...
				if(i30 > 0) {
					...
					f19 = (this.random.nextFloat() * 2.0F - 1.0F) * 0.2F / f28;
					GL11.glTranslatef(f17, f18, f19);
				}

				f17 = 1.0F;
				this.renderBlocks.renderBlockOnInventory(Block.blocksList[itemStack10.itemID], itemStack10.getItemDamage(), f17);
				GL11.glPopMatrix();
			}
		} else {
