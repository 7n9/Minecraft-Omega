...
public final class J_JdomParser {
	public J_JsonRootNode Parse(Reader reader1) throws IOException, J_InvalidSyntaxException {
	...
	public J_JsonRootNode parse(String string1) throws J_InvalidSyntaxException {
		try {
			J_JsonRootNode j_JsonRootNode2 = this.Parse(new StringReader(string1));
