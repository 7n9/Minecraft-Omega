...
public class WorldInfo {
	...
	public WorldInfo(NBTTagCompound nBTTagCompound1) {
		...
		this.field_35920_p = nBTTagCompound1.getInteger("GameType");
		if(nBTTagCompound1.hasKey("MapFeatures")) {
			this.field_35919_q = nBTTagCompound1.getBoolean("MapFeatures");
		} else {
	...
	public WorldInfo(WorldSettings worldSettings1, String string2) {
		this.randomSeed = worldSettings1.func_35518_a();
		this.field_35920_p = worldSettings1.func_35519_b();
		this.field_35919_q = worldSettings1.func_35520_c();
		this.levelName = string2;
	}

	public WorldInfo(WorldInfo worldInfo1) {
		this.randomSeed = worldInfo1.randomSeed;
		this.field_35920_p = worldInfo1.field_35920_p;
		this.field_35919_q = worldInfo1.field_35919_q;
	...
	private void updateTagCompound(NBTTagCompound nBTTagCompound1, NBTTagCompound nBTTagCompound2) {
		...
		nBTTagCompound1.setInteger("GameType", this.field_35920_p);
		nBTTagCompound1.setBoolean("MapFeatures", this.field_35919_q);
