...
public class ComponentVillageField extends ComponentVillage {
	...
	public static ComponentVillageField func_35080_a(List list0, Random random1, int i2, int i3, int i4, int i5, int i6) {
		StructureBoundingBox structureBoundingBox7 = StructureBoundingBox.func_35747_a(i2, i3, i4, 0, 0, 0, 13, 4, 9, i5);
		return func_35074_a(structureBoundingBox7) && StructureComponent.func_35020_a(list0, structureBoundingBox7) == null ? new ComponentVillageField(i6, random1, structureBoundingBox7, i5) : null;
	}
	...
	public boolean func_35023_a(World world1, Random random2, StructureBoundingBox structureBoundingBox3) {
		if(this.field_35081_a < 0) {
			this.field_35081_a = this.func_35075_b(world1, structureBoundingBox3);
			if(this.field_35081_a < 0) {
				return true;
			}
		...
		this.func_35011_a(world1, structureBoundingBox3, 0, 1, 0, 12, 4, 8, 0, 0, false);
		...
		this.func_35011_a(world1, structureBoundingBox3, 7, 0, 1, 8, 0, 7, Block.tilledField.blockID, Block.tilledField.blockID, false);
		this.func_35011_a(world1, structureBoundingBox3, 10, 0, 1, 11, 0, 7, Block.tilledField.blockID, Block.tilledField.blockID, false);
		...
		this.func_35011_a(world1, structureBoundingBox3, 12, 0, 0, 12, 0, 8, Block.wood.blockID, Block.wood.blockID, false);
		this.func_35011_a(world1, structureBoundingBox3, 1, 0, 0, 11, 0, 0, Block.wood.blockID, Block.wood.blockID, false);
		this.func_35011_a(world1, structureBoundingBox3, 1, 0, 8, 11, 0, 8, Block.wood.blockID, Block.wood.blockID, false);
		this.func_35011_a(world1, structureBoundingBox3, 3, 0, 1, 3, 0, 7, Block.waterMoving.blockID, Block.waterMoving.blockID, false);
		this.func_35011_a(world1, structureBoundingBox3, 9, 0, 1, 9, 0, 7, Block.waterMoving.blockID, Block.waterMoving.blockID, false);
		...
		for(i4 = 1; i4 <= 7; ++i4) {
			...
			this.func_35018_a(world1, Block.crops.blockID, MathHelper.func_35598_a(random2, 2, 7), 7, 1, i4, structureBoundingBox3);
			this.func_35018_a(world1, Block.crops.blockID, MathHelper.func_35598_a(random2, 2, 7), 8, 1, i4, structureBoundingBox3);
			this.func_35018_a(world1, Block.crops.blockID, MathHelper.func_35598_a(random2, 2, 7), 10, 1, i4, structureBoundingBox3);
			this.func_35018_a(world1, Block.crops.blockID, MathHelper.func_35598_a(random2, 2, 7), 11, 1, i4, structureBoundingBox3);
		}
