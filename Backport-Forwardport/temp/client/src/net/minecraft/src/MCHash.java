...
public class MCHash {
	...
	public boolean func_35858_b(int i1) {
		return this.func_35859_c(i1) != null;
	}

	final MCHashEntry func_35859_c(int i1) {
		int i2 = computeHash(i1);
