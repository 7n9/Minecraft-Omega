						...
						for(int i10 = i3 - 1; i10 <= i3 + 4; ++i10) {
							if(i8 != i2 || i10 != i3 || i9 != i4) {
								...
								if(i12 > 0) {
									...
									if(i13 > 0 && random5.nextInt(i11) <= i13 && (!world1.isRaining() || !world1.canLightningStrikeAt(i8, i10, i9)) && !world1.canLightningStrikeAt(i8 - 1, i10, i4) && !world1.canLightningStrikeAt(i8 + 1, i10, i9) && !world1.canLightningStrikeAt(i8, i10, i9 - 1) && !world1.canLightningStrikeAt(i8, i10, i9 + 1)) {
