...
public class BlockSilverfish extends Block {
	...
	public int getBlockTextureFromSideAndMetadata(int i1, int i2) {
		return i2 == 1 ? Block.cobblestone.blockIndexInTexture : (i2 == 2 ? Block.field_35285_bn.blockIndexInTexture : Block.stone.blockIndexInTexture);
	}
	...
	public static boolean func_35305_d(int i0) {
		return i0 == Block.stone.blockID || i0 == Block.cobblestone.blockID || i0 == Block.field_35285_bn.blockID;
	}

	public static int func_35304_f(int i0) {
		return i0 == Block.cobblestone.blockID ? 1 : (i0 == Block.field_35285_bn.blockID ? 2 : 0);
	}
}
