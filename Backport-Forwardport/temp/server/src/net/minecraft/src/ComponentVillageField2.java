...
public class ComponentVillageField2 extends ComponentVillage {
	...
	public static ComponentVillageField2 func_35399_a(List list0, Random random1, int i2, int i3, int i4, int i5, int i6) {
		StructureBoundingBox structureBoundingBox7 = StructureBoundingBox.func_35663_a(i2, i3, i4, 0, 0, 0, 7, 4, 9, i5);
		return func_35366_a(structureBoundingBox7) && StructureComponent.func_35312_a(list0, structureBoundingBox7) == null ? new ComponentVillageField2(i6, random1, structureBoundingBox7, i5) : null;
	}
	...
	public boolean func_35310_a(World world1, Random random2, StructureBoundingBox structureBoundingBox3) {
		if(this.field_35400_a < 0) {
			this.field_35400_a = this.func_35367_b(world1, structureBoundingBox3);
			if(this.field_35400_a < 0) {
				return true;
			}
		...
		this.func_35294_a(world1, structureBoundingBox3, 0, 1, 0, 6, 4, 8, 0, 0, false);
		...
		this.func_35294_a(world1, structureBoundingBox3, 1, 0, 0, 5, 0, 0, Block.wood.blockID, Block.wood.blockID, false);
		this.func_35294_a(world1, structureBoundingBox3, 1, 0, 8, 5, 0, 8, Block.wood.blockID, Block.wood.blockID, false);
