...
public class EntitySlime extends EntityLiving implements IMob {
	...
	public void setEntityDead() {
		...
		if(!this.worldObj.singleplayerWorld && i1 > 1 && this.health == 0) {
	...
	public void onCollideWithPlayer(EntityPlayer entityPlayer1) {
		int i2 = this.getSlimeSize();
		if(i2 > 1 && this.canEntityBeSeen(entityPlayer1) && (double)this.getDistanceToEntity(entityPlayer1) < 0.6D * (double)i2 && entityPlayer1.attackEntityFrom(DamageSource.func_35072_a(this), i2)) {
	...
	public boolean getCanSpawnHere() {
		...
		return (this.getSlimeSize() == 1 || this.worldObj.difficultySetting > 0) && this.rand.nextInt(10) == 0 && chunk1.func_334_a(987234911L).nextInt(10) == 0 && this.posY < 16.0D;
	}
