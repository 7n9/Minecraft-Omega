...
public class Chunk {
	...
	private void propagateSkylightOcclusion(int i1, int i2) {
		this.field_35636_d[i1 + i2 * 16] = true;
	}
		...
		if(world10000.doChunksNearChunkExist(i10001, 128 / 2, this.zPosition * 16 + 8, 16)) {
			for(int i1 = 0; i1 < 16; ++i1) {
				for(int i2 = 0; i2 < 16; ++i2) {
					if(this.field_35636_d[i1 + i2 * 16]) {
						this.field_35636_d[i1 + i2 * 16] = false;
	...
	private void checkSkylightNeighborHeight(int i1, int i2, int i3) {
		...
		if(i4 > i3) {
			this.func_35634_d(i1, i2, i3, i4 + 1);
		} else if(i4 < i3) {
			this.func_35634_d(i1, i2, i4, i3 + 1);
		}

	}

	private void func_35634_d(int i1, int i2, int i3, int i4) {
		if(i4 > i3) {
			World world10000 = this.worldObj;
			this.worldObj.getClass();
			if(world10000.doChunksNearChunkExist(i1, 128 / 2, i2, 16)) {
				for(int i5 = i3; i5 < i4; ++i5) {
					this.worldObj.func_35243_b(EnumSkyBlock.Sky, i1, i5, i2);
				}
	...
	private void relightBlock(int i1, int i2, int i3) {
		...
		if(i5 != i4) {
			...
			this.func_35634_d(i7 - 1, i8, i12, i13);
			this.func_35634_d(i7 + 1, i8, i12, i13);
			this.func_35634_d(i7, i8 - 1, i12, i13);
			this.func_35634_d(i7, i8 + 1, i12, i13);
			this.func_35634_d(i7, i8, i12, i13);
			this.isModified = true;
		}
	}
	...
	public boolean setBlockIDWithMetadata(int i1, int i2, int i3, int i4, int i5) {
		byte b6 = (byte)i4;
		int i7 = i3 << 4 | i1;
		if(i2 >= this.field_35637_c[i7] - 1) {
			this.field_35637_c[i7] = -999;
		}
		...
		if(i9 == i4 && this.data.getNibble(i1, i2, i3) == i5) {
			...
			if(i9 != 0 && !this.worldObj.singleplayerWorld) {
	...
	public boolean setBlockID(int i1, int i2, int i3, int i4) {
		byte b5 = (byte)i4;
		int i6 = i3 << 4 | i1;
		if(i2 >= this.field_35637_c[i6] - 1) {
			this.field_35637_c[i6] = -999;
		}
	...
	public void setBlockMetadata(int i1, int i2, int i3, int i4) {
		...
		if(i5 > 0 && Block.blocksList[i5] instanceof BlockContainer) {
			...
			if(tileEntity6 != null) {
				tileEntity6.func_35164_g();
				tileEntity6.field_35165_n = i4;
			}
		}
	...
	public void onChunkUnload() {
		...
		while(iterator1.hasNext()) {
			...
			this.worldObj.func_35239_a(tileEntity2);
		}
	...
	public void func_35632_a(IChunkProvider iChunkProvider1, IChunkProvider iChunkProvider2, int i3, int i4) {
	...
	public int func_35631_c(int i1, int i2) {
		int i3 = i1 | i2 << 4;
		int i4 = this.field_35637_c[i3];
		if(i4 == -999) {
			this.worldObj.getClass();
			int i5 = 128 - 1;
			i4 = -1;
