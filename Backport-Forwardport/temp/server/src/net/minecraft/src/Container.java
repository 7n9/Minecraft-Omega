...
public abstract class Container {
				...
				if(i1 == -999) {
					...
					if(itemStack7 != null) {
						...
						if(slot9 != null && slot9.getStack() != null && slot9.getStack().itemID == i8) {
							this.func_35497_b(i1, i2, z3, entityPlayer4);
						}
					}
				} else {
					if(i1 < 0) {
	...
	protected void func_35497_b(int i1, int i2, boolean z3, EntityPlayer entityPlayer4) {
	...
	public void func_35498_a(int i1, ItemStack itemStack2) {
