...
public final class SpawnerAnimals {
					...
					while(true) {
						...
						do {
							do {
								...
								spawnListEntry13 = (SpawnListEntry)WeightedRandom.func_35689_a(world0.rand, list12);
	...
	public static void func_35573_a(World world0, BiomeGenBase biomeGenBase1, int i2, int i3, int i4, int i5, Random random6) {
		List list7 = biomeGenBase1.getSpawnableList(EnumCreatureType.creature);
		if(!list7.isEmpty()) {
			while(random6.nextFloat() < biomeGenBase1.getBiome()) {
				SpawnListEntry spawnListEntry8 = (SpawnListEntry)WeightedRandom.func_35689_a(world0.rand, list7);
				int i9 = spawnListEntry8.field_35484_b + random6.nextInt(1 + spawnListEntry8.field_35485_c - spawnListEntry8.field_35484_b);
				...
				for(int i14 = 0; i14 < i9; ++i14) {
					...
					for(int i16 = 0; !z15 && i16 < 4; ++i16) {
						int i17 = world0.findTopSolidBlock(i10, i11);
