...
class StructureStrongholdStart extends StructureStart {
	public StructureStrongholdStart(World world1, Random random2, int i3, int i4) {
		...
		this.field_35547_a.add(componentStrongholdStairs25);
		componentStrongholdStairs25.func_35308_a(componentStrongholdStairs25, this.field_35547_a, random2);
		...
		while(!arrayList6.isEmpty()) {
			...
			structureComponent8.func_35308_a(componentStrongholdStairs25, this.field_35547_a, random2);
		}
