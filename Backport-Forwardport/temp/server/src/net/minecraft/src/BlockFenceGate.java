...
public class BlockFenceGate extends Block {
	...
	public AxisAlignedBB getCollisionBoundingBoxFromPool(World world1, int i2, int i3, int i4) {
		...
		return func_35070_c(i5) ? null : AxisAlignedBB.getBoundingBoxFromPool((double)i2, (double)i3, (double)i4, (double)(i2 + 1), (double)((float)i3 + 1.5F), (double)(i4 + 1));
	}
	...
	public static boolean func_35070_c(int i0) {
		return (i0 & 4) != 0;
	}

	public static int func_35071_d(int i0) {
		return i0 & 3;
	}
}
