...
public class ItemDye extends Item {
	...
	public boolean onItemUse(ItemStack itemStack1, EntityPlayer entityPlayer2, World world3, int i4, int i5, int i6, int i7) {
		if(!entityPlayer2.func_35200_c(i4, i5, i6)) {
			return false;
		} else {
			if(itemStack1.getItemDamage() == 15) {
				...
				if(i8 == Block.mushroomBrown.blockID || i8 == Block.mushroomRed.blockID) {
					if(!world3.singleplayerWorld && ((BlockMushroom)Block.blocksList[i8]).func_35065_b(world3, i4, i5, i6, world3.rand)) {
						--itemStack1.stackSize;
					}
				...
				if(i8 == Block.field_35050_bu.blockID || i8 == Block.field_35051_bt.blockID) {
					if(!world3.singleplayerWorld) {
						((BlockStem)Block.blocksList[i8]).func_35066_f_(world3, i4, i5, i6);
						--itemStack1.stackSize;
					}
