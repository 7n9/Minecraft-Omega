...
public class CraftingManager {
	...
	private CraftingManager() {
		...
		this.addRecipe(new ItemStack(Block.field_35044_bw, 1), new Object[]{"#W#", "#W#", '#', Item.stick, 'W', Block.planks});
		...
		this.addRecipe(new ItemStack(Block.stairSingle, 3, 5), new Object[]{"###", '#', Block.field_35052_bn});
		...
		this.addRecipe(new ItemStack(Block.field_35047_bx, 4), new Object[]{"#  ", "## ", "###", '#', Block.brick});
		this.addRecipe(new ItemStack(Block.field_35046_by, 4), new Object[]{"#  ", "## ", "###", '#', Block.field_35052_bn});
