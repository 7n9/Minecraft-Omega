...
public class EntityEgg extends Entity {
	...
	public void onUpdate() {
		...
		if(!this.worldObj.singleplayerWorld) {
			...
			for(int i8 = 0; i8 < list5.size(); ++i8) {
				...
				if(entity9.canBeCollidedWith() && (entity9 != this.owner || this.field_20079_al >= 5)) {
					float f10 = 0.3F;
		...
		if(movingObjectPosition3 != null) {
			if(movingObjectPosition3.entityHit != null && movingObjectPosition3.entityHit.attackEntityFrom(DamageSource.func_35081_a(this, this.owner), 0)) {
				;
			}
	...
	public void onCollideWithPlayer(EntityPlayer entityPlayer1) {
		if(this.inGround && this.owner == entityPlayer1 && this.shake <= 0 && entityPlayer1.inventory.addItemStackToInventory(new ItemStack(Item.arrow, 1))) {
